...
typedef enum XrResult {
    ...
    XR_ERROR_SPATIAL_SENSING_SERVICE_UNAVAILABLE_PICO = -1200389027,
    XR_ERROR_SPATIAL_ANCHOR_SHARING_NETWORK_TIMEOUT_PICO = -1200391101,
    XR_ERROR_SPATIAL_ANCHOR_SHARING_AUTHENTICATION_FAILURE_PICO = -1200391102,
    XR_ERROR_SPATIAL_ANCHOR_SHARING_NETWORK_FAILURE_PICO = -1200391103,
    XR_ERROR_SPATIAL_ANCHOR_SHARING_LOCALIZATION_FAIL_PICO = -1200391104,
    XR_ERROR_SPATIAL_ANCHOR_SHARING_MAP_INSUFFICIENT_PICO = -1200391105,
...
typedef enum XrStructureType {
    ...
    XR_TYPE_SYMMETRIC_FOV_REPROJECTION_VIEW_CONFIGURATION_PICO = 1010016000,
    XR_TYPE_LAYER_COLOR_MATRIX_PICO = 1010026000,
    XR_TYPE_READBACK_TENSOR_BUFFER_PICO = 1010027000,
    XR_TYPE_CREATE_BUFFER_FROM_GLOBAL_TENSOR_COMPLETION_PICO = 1010027001,
    XR_TYPE_CREATE_TEXTURE_FROM_GLOBAL_TENSOR_COMPLETION_PICO = 1010027002,
    XR_TYPE_READBACK_TENSOR_TEXTURE_PICO = 1010027003,
    XR_TYPE_READBACK_TEXTURE_IMAGE_BASE_PICO = 1010027004,
    XR_TYPE_READBACK_TEXTURE_IMAGE_VULKAN_PICO = 1010028000,
    XR_TYPE_READBACK_TEXTURE_IMAGE_OPENGL_PICO = 1010029000,
    XR_TYPE_SYSTEM_SPATIAL_SENSING_PROPERTIES_PICO = 1200389000,
    XR_TYPE_SPATIAL_ENTITY_LOCATION_GET_INFO_PICO = 1200389002,
    XR_TYPE_SPATIAL_ENTITY_LOCATION_DATA_PICO = 1200389003,
    XR_TYPE_SPATIAL_ENTITY_SEMANTIC_GET_INFO_PICO = 1200389004,
    XR_TYPE_SPATIAL_ENTITY_SEMANTIC_DATA_PICO = 1200389005,
    XR_TYPE_SPATIAL_ENTITY_BOUNDING_BOX_2D_GET_INFO_PICO = 1200389006,
    XR_TYPE_SPATIAL_ENTITY_BOUNDING_BOX_2D_DATA_PICO = 1200389007,
    XR_TYPE_SPATIAL_ENTITY_POLYGON_GET_INFO_PICO = 1200389008,
    XR_TYPE_SPATIAL_ENTITY_POLYGON_DATA_PICO = 1200389009,
    XR_TYPE_SPATIAL_ENTITY_BOUNDING_BOX_3D_GET_INFO_PICO = 1200389010,
    XR_TYPE_SPATIAL_ENTITY_BOUNDING_BOX_3D_DATA_PICO = 1200389011,
    XR_TYPE_SPATIAL_ENTITY_TRIANGLE_MESH_GET_INFO_PICO = 1200389012,
    XR_TYPE_SPATIAL_ENTITY_TRIANGLE_MESH_DATA_PICO = 1200389013,
    XR_TYPE_SENSE_DATA_PROVIDER_START_COMPLETION_PICO = 1200389014,
    XR_TYPE_EVENT_DATA_SENSE_DATA_PROVIDER_STATE_CHANGED_PICO = 1200389015,
    XR_TYPE_SENSE_DATA_FILTER_UUID_PICO = 1200389016,
    XR_TYPE_SENSE_DATA_FILTER_SEMANTIC_PICO = 1200389017,
    XR_TYPE_SENSE_DATA_QUERY_INFO_PICO = 1200389018,
    XR_TYPE_SENSE_DATA_QUERY_COMPLETION_PICO = 1200389019,
    XR_TYPE_QUERIED_SENSE_DATA_GET_INFO_PICO = 1200389020,
    XR_TYPE_SPATIAL_ENTITY_STATE_PICO = 1200389021,
    XR_TYPE_QUERIED_SENSE_DATA_PICO = 1200389022,
    XR_TYPE_EVENT_DATA_SENSE_DATA_UPDATED_PICO = 1200389023,
    XR_TYPE_SENSE_DATA_PROVIDER_START_INFO_PICO = 1200389024,
    XR_TYPE_SPATIAL_ENTITY_ANCHOR_RETRIEVE_INFO_PICO = 1200389025,
    XR_TYPE_ANCHOR_LOCATE_INFO_PICO = 1200389026,
    XR_TYPE_FUTURE_POLL_RESULT_PROGRESS_PICO = 1200389028,
    XR_TYPE_SYSTEM_SPATIAL_ANCHOR_PROPERTIES_PICO = 1200390000,
    XR_TYPE_SENSE_DATA_PROVIDER_CREATE_INFO_SPATIAL_ANCHOR_PICO = 1200390001,
    XR_TYPE_SPATIAL_ANCHOR_CREATE_INFO_PICO = 1200390002,
    XR_TYPE_SPATIAL_ANCHOR_CREATE_COMPLETION_PICO = 1200390003,
    XR_TYPE_SPATIAL_ANCHOR_PERSIST_INFO_PICO = 1200390004,
    XR_TYPE_SPATIAL_ANCHOR_PERSIST_COMPLETION_PICO = 1200390005,
    XR_TYPE_SPATIAL_ANCHOR_UNPERSIST_INFO_PICO = 1200390006,
    XR_TYPE_SPATIAL_ANCHOR_UNPERSIST_COMPLETION_PICO = 1200390007,
    XR_TYPE_SYSTEM_SPATIAL_ANCHOR_SHARING_PROPERTIES_PICO = 1200391000,
    XR_TYPE_SPATIAL_ANCHOR_SHARE_INFO_PICO = 1200391001,
    XR_TYPE_SPATIAL_ANCHOR_SHARE_COMPLETION_PICO = 1200391002,
    XR_TYPE_SPATIAL_ANCHOR_DOWNLOAD_INFO_PICO = 1200391003,
    XR_TYPE_SPATIAL_ANCHOR_DOWNLOAD_COMPLETION_PICO = 1200391004,
    XR_TYPE_SYSTEM_SCENE_CAPTURE_PROPERTIES_PICO = 1200392000,
    XR_TYPE_SCENE_CAPTURE_START_INFO_PICO = 1200392001,
    XR_TYPE_SCENE_CAPTURE_START_COMPLETION_PICO = 1200392002,
    XR_TYPE_SENSE_DATA_PROVIDER_CREATE_INFO_SCENE_CAPTURE_PICO = 1200392003,
    XR_TYPE_SYSTEM_SPATIAL_MESH_PROPERTIES_PICO = 1200393000,
    XR_TYPE_SENSE_DATA_PROVIDER_CREATE_INFO_SPATIAL_MESH_PICO = 1200393001,
...
typedef enum XrViewConfigurationType {
    ...
    XR_VIEW_CONFIGURATION_TYPE_PRIMARY_STEREO_SYMMETRIC_FOV_REPROJECTION_PICO = 1010016000,
...
typedef enum XrObjectType {
    ...
    XR_OBJECT_TYPE_SENSE_DATA_PROVIDER_PICO = 1200389000,
    XR_OBJECT_TYPE_SENSE_DATA_SNAPSHOT_PICO = 1200389001,
    XR_OBJECT_TYPE_ANCHOR_PICO = 1200389002,
...
static const XrCompositionLayerFlags XR_COMPOSITION_LAYER_REPROJECTION_BIT_PICO = 0x80000000;
...
// XR_PICO_external_camera is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_external_camera 1
#define XR_PICO_external_camera_SPEC_VERSION 1
#define XR_PICO_EXTERNAL_CAMERA_EXTENSION_NAME "XR_PICO_external_camera"
...
typedef XrResult (XRAPI_PTR *PFN_xrGetExternalCameraInfoPICO)(XrSession session, XrExternalCameraParameterPICO* info);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrGetExternalCameraInfoPICO(
    XrSession                                   session,
...
// XR_PICO_virtual_boundary is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_virtual_boundary 1
#define XR_PICO_virtual_boundary_SPEC_VERSION 1
#define XR_PICO_VIRTUAL_BOUNDARY_EXTENSION_NAME "XR_PICO_virtual_boundary"
...
typedef struct XR_MAY_ALIAS XrVirtualBoundaryTriggerBaseHeaderPICO {
    XrStructureType               type;
    void* XR_MAY_ALIAS            next;
...
typedef XrResult    (XRAPI_PTR *PFN_xrGetVirtualBoundaryModePICO)(XrSession   session, XrVirtualBoundaryModePICO*  mode);
typedef XrResult    (XRAPI_PTR *PFN_xrGetVirtualBoundaryStatusPICO)(XrSession   session, XrVirtualBoundaryStatusPICO*  status);
typedef XrResult    (XRAPI_PTR *PFN_xrSetVirtualBoundaryEnablePICO)(XrSession   session, XrBool32    enable);
typedef XrResult    (XRAPI_PTR *PFN_xrSetVirtualBoundaryVisiblePICO)(XrSession   session, XrBool32  visible);
typedef XrResult    (XRAPI_PTR *PFN_xrGetVirtualBoundaryGeometryPICO)(XrSession   session, const XrVirtualBoundaryInfoPICO* boundaryInfo, uint32_t   geometryCapacityInput, uint32_t*  geometryCountOutput, XrVector3f*  geometries);
typedef XrResult    (XRAPI_PTR *PFN_xrGetVirtualBoundaryTriggerPICO)(XrSession   session, const XrVirtualBoundaryTriggerBaseHeaderPICO*     triggerInfo, XrVirtualBoundaryTriggerPICO* boundaryTrigger);
typedef XrResult    (XRAPI_PTR *PFN_xrSetVirtualBoundarySeeThroughVisiblePICO)(XrSession   session, XrBool32    visible);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult    XRAPI_CALL xrGetVirtualBoundaryModePICO(
    XrSession                                   session,
    XrVirtualBoundaryModePICO*                  mode);

XRAPI_ATTR XrResult    XRAPI_CALL xrGetVirtualBoundaryStatusPICO(
    XrSession                                   session,
    XrVirtualBoundaryStatusPICO*                status);

XRAPI_ATTR XrResult    XRAPI_CALL xrSetVirtualBoundaryEnablePICO(
    XrSession                                   session,
    XrBool32                                    enable);

XRAPI_ATTR XrResult    XRAPI_CALL xrSetVirtualBoundaryVisiblePICO(
    XrSession                                   session,
    XrBool32                                    visible);

XRAPI_ATTR XrResult    XRAPI_CALL xrGetVirtualBoundaryGeometryPICO(
    XrSession                                   session,
...
XRAPI_ATTR XrResult    XRAPI_CALL xrGetVirtualBoundaryTriggerPICO(
    XrSession                                   session,
    const XrVirtualBoundaryTriggerBaseHeaderPICO* triggerInfo,
    XrVirtualBoundaryTriggerPICO*               boundaryTrigger);

XRAPI_ATTR XrResult    XRAPI_CALL xrSetVirtualBoundarySeeThroughVisiblePICO(
    XrSession                                   session,
    XrBool32                                    visible);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
...
// XR_PICO_motion_tracking is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_motion_tracking 1
XR_DEFINE_ATOM(XrMotionTrackerIdPICO)
#define XR_PICO_motion_tracking_SPEC_VERSION 1
#define XR_PICO_MOTION_TRACKING_EXTENSION_NAME "XR_PICO_motion_tracking"
#define XR_MOTION_TRACKER_MAX_SIZE_PICO   6
...
typedef XrResult (XRAPI_PTR *PFN_xrRequestMotionTrackerDevicePICO)(XrSession session, uint32_t deviceCount);
typedef XrResult (XRAPI_PTR *PFN_xrGetMotionTrackerBatteryStatePICO)(XrSession session, XrMotionTrackerIdPICO trackerId, XrMotionTrackerBatteryStatePICO* batteryState);
typedef XrResult (XRAPI_PTR *PFN_xrLocateMotionTrackerPICO)(XrSession session, XrMotionTrackerIdPICO trackerId, const XrMotionTrackerLocationInfoPICO* locationInfo, XrMotionTrackerSpaceLocationPICO* location);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrRequestMotionTrackerDevicePICO(
    XrSession                                   session,
    uint32_t                                    deviceCount);

XRAPI_ATTR XrResult XRAPI_CALL xrGetMotionTrackerBatteryStatePICO(
    XrSession                                   session,
    XrMotionTrackerIdPICO                       trackerId,
    XrMotionTrackerBatteryStatePICO*            batteryState);

XRAPI_ATTR XrResult XRAPI_CALL xrLocateMotionTrackerPICO(
    XrSession                                   session,
    XrMotionTrackerIdPICO                       trackerId,
...
// XR_PICO_composition_layer_fisheye is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_composition_layer_fisheye 1
#define XR_PICO_composition_layer_fisheye_SPEC_VERSION 1
#define XR_PICO_COMPOSITION_LAYER_FISHEYE_EXTENSION_NAME "XR_PICO_composition_layer_fisheye"
...
// XR_PICO_layer_settings is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_layer_settings 1
#define XR_PICO_layer_settings_SPEC_VERSION 1
#define XR_PICO_LAYER_SETTINGS_EXTENSION_NAME "XR_PICO_layer_settings"
typedef XrFlags64 XrLayerSettingsFlagsPICO;
...
// XrLayerSettingsPICO extends XrCompositionLayerBaseHeader
...
// XR_PICO_eye_tracker is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_eye_tracker 1
XR_DEFINE_HANDLE(XrEyeTrackerPICO)
#define XR_PICO_eye_tracker_SPEC_VERSION  1
#define XR_PICO_EYE_TRACKER_EXTENSION_NAME "XR_PICO_eye_tracker"
...
typedef XrResult (XRAPI_PTR *PFN_xrCreateEyeTrackerPICO)(XrSession session, const XrEyeTrackerCreateInfoPICO* createInfo, XrEyeTrackerPICO* tracker);
typedef XrResult (XRAPI_PTR *PFN_xrDestroyEyeTrackerPICO)(XrEyeTrackerPICO eyeTracker);
typedef XrResult (XRAPI_PTR *PFN_xrGetEyeDataPICO)(XrEyeTrackerPICO tracker, const XrEyeTrackerDataInfoPICO* info, XrEyeTrackerDataPICO* eyeTrackerData);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrCreateEyeTrackerPICO(
    XrSession                                   session,
    const XrEyeTrackerCreateInfoPICO*           createInfo,
    XrEyeTrackerPICO*                           tracker);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroyEyeTrackerPICO(
    XrEyeTrackerPICO                            eyeTracker);

XRAPI_ATTR XrResult XRAPI_CALL xrGetEyeDataPICO(
    XrEyeTrackerPICO                            tracker,
...
// XR_PICO_secure_mixed_reality is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_secure_mixed_reality 1
...
#define XR_MAX_OPERATOR_NODE_NAME_PICO    512
#define XR_MAX_ARITHMETIC_COMPOSE_OPERATOR_CONFIG_LENGTH_PICO 2048
#define XR_PICO_secure_mixed_reality_SPEC_VERSION 1
#define XR_PICO_SECURE_MIXED_REALITY_EXTENSION_NAME "XR_PICO_secure_mixed_reality"
...
typedef enum XrSecureMrOperatorTypePICO {
    ...
    XR_SECURE_MR_OPERATOR_TYPE_SVD_PICO = 34,
    XR_SECURE_MR_OPERATOR_TYPE_NORM_PICO = 35,
    XR_SECURE_MR_OPERATOR_TYPE_SWAP_HWC_CHW_PICO = 36,
    XR_SECURE_MR_OPERATOR_TYPE_JAVASCRIPT_PICO = 39,
...
typedef enum XrSecureMrTensorDataTypePICO {
    ...
    XR_SECURE_MR_TENSOR_DATA_TYPE_DYNAMIC_TEXTURE_UINT8_PICO = 8,
    XR_SECURE_MR_TENSOR_DATA_TYPE_DYNAMIC_TEXTURE_FLOAT32_PICO = 9,
...
typedef enum XrSecureMrTensorTypePICO {
    ...
    XR_SECURE_MR_TENSOR_TYPE_MAT_DYNAMIC_TEXTURE_PICO = 8,
...
typedef struct XR_MAY_ALIAS XrSecureMrOperatorBaseHeaderPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
...
typedef struct XR_MAY_ALIAS XrSecureMrTensorCreateInfoBaseHeaderPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
...
typedef struct XrSecureMrOperatorJavascriptPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    char*                       configText;
    int32_t                     configLength;
} XrSecureMrOperatorJavascriptPICO;

typedef XrResult (XRAPI_PTR *PFN_xrCreateSecureMrFrameworkPICO)(XrSession session, const XrSecureMrFrameworkCreateInfoPICO* createInfo, XrSecureMrFrameworkPICO* framework);
typedef XrResult (XRAPI_PTR *PFN_xrDestroySecureMrFrameworkPICO)(XrSecureMrFrameworkPICO framework);
typedef XrResult (XRAPI_PTR *PFN_xrCreateSecureMrPipelinePICO)(XrSecureMrFrameworkPICO framework, const XrSecureMrPipelineCreateInfoPICO* createInfo, XrSecureMrPipelinePICO* pipeline);
typedef XrResult (XRAPI_PTR *PFN_xrDestroySecureMrPipelinePICO)(XrSecureMrPipelinePICO pipeline);
typedef XrResult (XRAPI_PTR *PFN_xrCreateSecureMrOperatorPICO)(XrSecureMrPipelinePICO pipeline, const XrSecureMrOperatorCreateInfoPICO* createInfo, XrSecureMrOperatorPICO* secureMrOperator);
typedef XrResult (XRAPI_PTR *PFN_xrCreateSecureMrTensorPICO)(XrSecureMrFrameworkPICO framework, const XrSecureMrTensorCreateInfoBaseHeaderPICO* createInfo, XrSecureMrTensorPICO* globalTensor);
typedef XrResult (XRAPI_PTR *PFN_xrDestroySecureMrTensorPICO)(XrSecureMrTensorPICO globalTensor);
typedef XrResult (XRAPI_PTR *PFN_xrCreateSecureMrPipelineTensorPICO)(XrSecureMrPipelinePICO pipeline, const XrSecureMrTensorCreateInfoBaseHeaderPICO* createInfo, XrSecureMrPipelineTensorPICO* pipelineTensor);
typedef XrResult (XRAPI_PTR *PFN_xrResetSecureMrTensorPICO)(XrSecureMrTensorPICO tensor, XrSecureMrTensorBufferPICO*  tensorBuffer);
typedef XrResult (XRAPI_PTR *PFN_xrResetSecureMrPipelineTensorPICO)(XrSecureMrPipelinePICO pipeline, XrSecureMrPipelineTensorPICO tensor, XrSecureMrTensorBufferPICO*  tensorBuffer);
typedef XrResult (XRAPI_PTR *PFN_xrSetSecureMrOperatorOperandByNamePICO)(XrSecureMrPipelinePICO pipeline, XrSecureMrOperatorPICO tensorOperator, XrSecureMrPipelineTensorPICO pipelineTensor, const char* inputName);
typedef XrResult (XRAPI_PTR *PFN_xrSetSecureMrOperatorOperandByIndexPICO)(XrSecureMrPipelinePICO pipeline, XrSecureMrOperatorPICO tensorOperator, XrSecureMrPipelineTensorPICO pipelineTensor, int32_t index);
typedef XrResult (XRAPI_PTR *PFN_xrExecuteSecureMrPipelinePICO)(XrSecureMrPipelinePICO pipeline, const XrSecureMrPipelineExecuteParameterPICO*  parameter, XrSecureMrPipelineRunPICO* pipelineRun);
typedef XrResult (XRAPI_PTR *PFN_xrSetSecureMrOperatorResultByNamePICO)(XrSecureMrPipelinePICO pipeline, XrSecureMrOperatorPICO tensorOperator, XrSecureMrPipelineTensorPICO pipelineTensor, const char* name);
typedef XrResult (XRAPI_PTR *PFN_xrSetSecureMrOperatorResultByIndexPICO)(XrSecureMrPipelinePICO pipeline, XrSecureMrOperatorPICO tensorOperator, XrSecureMrPipelineTensorPICO pipelineTensor, int32_t index);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrCreateSecureMrFrameworkPICO(
    XrSession                                   session,
    const XrSecureMrFrameworkCreateInfoPICO*    createInfo,
    XrSecureMrFrameworkPICO*                    framework);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroySecureMrFrameworkPICO(
    XrSecureMrFrameworkPICO                     framework);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSecureMrPipelinePICO(
    XrSecureMrFrameworkPICO                     framework,
    const XrSecureMrPipelineCreateInfoPICO*     createInfo,
    XrSecureMrPipelinePICO*                     pipeline);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroySecureMrPipelinePICO(
    XrSecureMrPipelinePICO                      pipeline);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSecureMrOperatorPICO(
    XrSecureMrPipelinePICO                      pipeline,
    const XrSecureMrOperatorCreateInfoPICO*     createInfo,
    XrSecureMrOperatorPICO*                     secureMrOperator);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSecureMrTensorPICO(
    XrSecureMrFrameworkPICO                     framework,
    const XrSecureMrTensorCreateInfoBaseHeaderPICO* createInfo,
    XrSecureMrTensorPICO*                       globalTensor);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroySecureMrTensorPICO(
    XrSecureMrTensorPICO                        globalTensor);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSecureMrPipelineTensorPICO(
    XrSecureMrPipelinePICO                      pipeline,
    const XrSecureMrTensorCreateInfoBaseHeaderPICO* createInfo,
    XrSecureMrPipelineTensorPICO*               pipelineTensor);

XRAPI_ATTR XrResult XRAPI_CALL xrResetSecureMrTensorPICO(
    XrSecureMrTensorPICO                        tensor,
    XrSecureMrTensorBufferPICO*                 tensorBuffer);

XRAPI_ATTR XrResult XRAPI_CALL xrResetSecureMrPipelineTensorPICO(
    XrSecureMrPipelinePICO                      pipeline,
    XrSecureMrPipelineTensorPICO                tensor,
    XrSecureMrTensorBufferPICO*                 tensorBuffer);

XRAPI_ATTR XrResult XRAPI_CALL xrSetSecureMrOperatorOperandByNamePICO(
    XrSecureMrPipelinePICO                      pipeline,
    XrSecureMrOperatorPICO                      tensorOperator,
    XrSecureMrPipelineTensorPICO                pipelineTensor,
    const char*                                 inputName);

XRAPI_ATTR XrResult XRAPI_CALL xrSetSecureMrOperatorOperandByIndexPICO(
    XrSecureMrPipelinePICO                      pipeline,
    XrSecureMrOperatorPICO                      tensorOperator,
    XrSecureMrPipelineTensorPICO                pipelineTensor,
    int32_t                                     index);

XRAPI_ATTR XrResult XRAPI_CALL xrExecuteSecureMrPipelinePICO(
    XrSecureMrPipelinePICO                      pipeline,
    const XrSecureMrPipelineExecuteParameterPICO* parameter,
    XrSecureMrPipelineRunPICO*                  pipelineRun);

XRAPI_ATTR XrResult XRAPI_CALL xrSetSecureMrOperatorResultByNamePICO(
    XrSecureMrPipelinePICO                      pipeline,
    XrSecureMrOperatorPICO                      tensorOperator,
    XrSecureMrPipelineTensorPICO                pipelineTensor,
    const char*                                 name);

XRAPI_ATTR XrResult XRAPI_CALL xrSetSecureMrOperatorResultByIndexPICO(
    XrSecureMrPipelinePICO                      pipeline,
    XrSecureMrOperatorPICO                      tensorOperator,
    XrSecureMrPipelineTensorPICO                pipelineTensor,
    int32_t                                     index);
...
// XR_PICO_expand_device is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_expand_device 1
XR_DEFINE_ATOM(XrExpandDeviceIdPICO)
#define XR_MAX_EXPAND_DEVICE_CUSTOM_DATA_SIZE_PICO 15
#define XR_PICO_expand_device_SPEC_VERSION 1
#define XR_PICO_EXPAND_DEVICE_EXTENSION_NAME "XR_PICO_expand_device"
...
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateExpandDevicePICO)(XrSession session, uint32_t deviceCapacityInput, uint32_t* deviceCountOutput, XrExpandDeviceIdPICO* devices);
typedef XrResult (XRAPI_PTR *PFN_xrSetExpandDeviceMotorVibratePICO)(XrSession session, XrExpandDeviceIdPICO expandDevice, XrExpandDeviceMotorVibratePICO* vibrate);
typedef XrResult (XRAPI_PTR *PFN_xrGetExpandDeviceBatteryStatePICO)(XrSession session, XrExpandDeviceIdPICO expandDevice, XrExpandDeviceBatteryStatePICO* batteryState);
typedef XrResult (XRAPI_PTR *PFN_xrSetExpandDeviceCustomDataCapabilityPICO)(XrSession session, XrBool32 enable);
typedef XrResult (XRAPI_PTR *PFN_xrSetExpandDeviceCustomDataPICO)(XrSession session, uint32_t dataCount, const XrExpandDeviceCustomDataPICO* customData);
typedef XrResult (XRAPI_PTR *PFN_xrGetExpandDeviceCustomDataPICO)(XrSession session, uint32_t customDataCapacityInput, uint32_t* customDataCountOutput, XrExpandDeviceCustomDataPICO* customDatas);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrEnumerateExpandDevicePICO(
    XrSession                                   session,
    uint32_t                                    deviceCapacityInput,
    uint32_t*                                   deviceCountOutput,
    XrExpandDeviceIdPICO*                       devices);

XRAPI_ATTR XrResult XRAPI_CALL xrSetExpandDeviceMotorVibratePICO(
    XrSession                                   session,
    XrExpandDeviceIdPICO                        expandDevice,
    XrExpandDeviceMotorVibratePICO*             vibrate);

XRAPI_ATTR XrResult XRAPI_CALL xrGetExpandDeviceBatteryStatePICO(
    XrSession                                   session,
    XrExpandDeviceIdPICO                        expandDevice,
    XrExpandDeviceBatteryStatePICO*             batteryState);

XRAPI_ATTR XrResult XRAPI_CALL xrSetExpandDeviceCustomDataCapabilityPICO(
    XrSession                                   session,
    XrBool32                                    enable);

XRAPI_ATTR XrResult XRAPI_CALL xrSetExpandDeviceCustomDataPICO(
    XrSession                                   session,
    uint32_t                                    dataCount,
    const XrExpandDeviceCustomDataPICO*         customData);

XRAPI_ATTR XrResult XRAPI_CALL xrGetExpandDeviceCustomDataPICO(
    XrSession                                   session,
...
// XR_PICO_body_tracking2 is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_body_tracking2 1
#define XR_PICO_body_tracking2_SPEC_VERSION 1
#define XR_PICO_BODY_TRACKING2_EXTENSION_NAME "XR_PICO_body_tracking2"
...
typedef XrResult (XRAPI_PTR *PFN_xrStartBodyTrackingCalibrationAppPICO)(XrSession session);
typedef XrResult (XRAPI_PTR *PFN_xrGetBodyTrackingStatePICO)(XrSession session, XrBodyTrackingStatePICO* state);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrStartBodyTrackingCalibrationAppPICO(
    XrSession                                   session);

XRAPI_ATTR XrResult XRAPI_CALL xrGetBodyTrackingStatePICO(
    XrSession                                   session,
...
// XR_PICO_adaptive_resolution is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_adaptive_resolution 1
#define XR_PICO_adaptive_resolution_SPEC_VERSION 1
#define XR_PICO_ADAPTIVE_RESOLUTION_EXTENSION_NAME "XR_PICO_adaptive_resolution"
...
typedef XrResult (XRAPI_PTR *PFN_xrUpdateAdaptiveResolutionPICO)(XrSession session, XrAdaptiveResolutionSettingPICO setting, XrExtent2Di currentResolution, XrExtent2Di* lastResolution);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrUpdateAdaptiveResolutionPICO(
    XrSession                                   session,
...
// XR_PICO_symmetric_fov_reprojection_view_configuration is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_symmetric_fov_reprojection_view_configuration 1
#define XR_PICO_symmetric_fov_reprojection_view_configuration_SPEC_VERSION 1
#define XR_PICO_SYMMETRIC_FOV_REPROJECTION_VIEW_CONFIGURATION_EXTENSION_NAME "XR_PICO_symmetric_fov_reprojection_view_configuration"
typedef struct XrSymmetricFovReprojectionViewConfigurationPICO {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    uint32_t              recommendedSymmetricFovImageRectWidth;
    uint32_t              recommendedNotRenderingImageRectWidth;
} XrSymmetricFovReprojectionViewConfigurationPICO;



// XR_PICO_layer_color_matrix is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_layer_color_matrix 1
#define XR_PICO_layer_color_matrix_SPEC_VERSION 1
#define XR_PICO_LAYER_COLOR_MATRIX_EXTENSION_NAME "XR_PICO_layer_color_matrix"
...
typedef XrResult (XRAPI_PTR *PFN_xrCreateTextureFromGlobalTensorCompletePICO)(XrSecureMrTensorPICO tensor, XrFutureEXT  future, XrCreateTextureFromGlobalTensorCompletionPICO* completion);
...
#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrCreateBufferFromGlobalTensorAsyncPICO(
    XrSecureMrTensorPICO                        tensor,
    XrFutureEXT*                                future);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateBufferFromGlobalTensorCompletePICO(
    XrSecureMrTensorPICO                        tensor,
    XrFutureEXT                                 future,
    XrCreateBufferFromGlobalTensorCompletionPICO* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateTextureFromGlobalTensorAsyncPICO(
    XrSecureMrTensorPICO                        tensor,
    XrFutureEXT*                                future);
...
XRAPI_ATTR XrResult XRAPI_CALL xrGetReadbackTextureImagePICO(
    XrReadbackTexturePICO                       readbackTexture,
    XrReadbackTextureImageBasePICO*             img);

XRAPI_ATTR XrResult XRAPI_CALL xrReleaseReadbackTexturePICO(
    XrReadbackTexturePICO                       readbackTexture);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */


// XR_PICO_spatial_sensing is a preprocessor guard. Do not pass it to API calls.
...
typedef enum XrSemanticLabelPICO {
    ...
    XR_SEMANTIC_LABEL_STAIRWAY_PICO = 24,
...
// XrSystemSpatialSensingPropertiesPICO extends XrSystemProperties
...
// XrSpatialEntityLocationGetInfoPICO extends XrSpatialEntityComponentGetInfoBaseHeaderPICO
...
// XrSpatialEntityLocationDataPICO extends XrSpatialEntityComponentDataBaseHeaderPICO
...
// XrSpatialEntitySemanticGetInfoPICO extends XrSpatialEntityComponentGetInfoBaseHeaderPICO
...
// XrSpatialEntitySemanticDataPICO extends XrSpatialEntityComponentDataBaseHeaderPICO
...
// XrSpatialEntityBoundingBox2DGetInfoPICO extends XrSpatialEntityComponentGetInfoBaseHeaderPICO
...
// XrSpatialEntityBoundingBox2DDataPICO extends XrSpatialEntityComponentDataBaseHeaderPICO
...
// XrSpatialEntityPolygonDataPICO extends XrSpatialEntityComponentDataBaseHeaderPICO
...
// XrSpatialEntityBoundingBox3DGetInfoPICO extends XrSpatialEntityComponentGetInfoBaseHeaderPICO
...
// XrSpatialEntityBoundingBox3DDataPICO extends XrSpatialEntityComponentDataBaseHeaderPICO
...
// XrSpatialEntityTriangleMeshDataPICO extends XrSpatialEntityComponentDataBaseHeaderPICO
...
typedef struct XR_MAY_ALIAS XrSenseDataProviderCreateInfoBaseHeaderPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
...
typedef struct XR_MAY_ALIAS XrSenseDataFilterBaseHeaderPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
...
typedef struct XrSenseDataQueryInfoPICO {
    XrStructureType                     type;
    const void* XR_MAY_ALIAS            next;
    XrSenseDataFilterBaseHeaderPICO*    filter;
...
typedef struct XrFuturePollResultProgressPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    int32_t                     progress;
} XrFuturePollResultProgressPICO;

typedef XrResult (XRAPI_PTR *PFN_xrEnumerateSpatialEntityComponentTypesPICO)(XrSenseDataSnapshotPICO snapshot, XrSpatialEntityIdPICO entity, uint32_t componentTypeCapacityInput, uint32_t* componentTypeCountOutput, XrSpatialEntityComponentTypePICO* componentTypes);
typedef XrResult (XRAPI_PTR *PFN_xrGetSpatialEntityUuidPICO)(XrSenseDataSnapshotPICO snapshot, XrSpatialEntityIdPICO entity, XrUuidEXT* uuid);
typedef XrResult (XRAPI_PTR *PFN_xrGetSpatialEntityComponentDataPICO)(XrSenseDataSnapshotPICO snapshot, XrSpatialEntityComponentGetInfoBaseHeaderPICO* getInfo, XrSpatialEntityComponentDataBaseHeaderPICO* componentData);
typedef XrResult (XRAPI_PTR *PFN_xrCreateSenseDataProviderPICO)(XrSession session, XrSenseDataProviderCreateInfoBaseHeaderPICO* createInfo, XrSenseDataProviderPICO* provider);
typedef XrResult (XRAPI_PTR *PFN_xrStartSenseDataProviderAsyncPICO)(XrSession session, XrSenseDataProviderStartInfoPICO* startInfo, XrFutureEXT* future);
typedef XrResult (XRAPI_PTR *PFN_xrStartSenseDataProviderCompletePICO)(XrSession session, XrFutureEXT future, XrSenseDataProviderStartCompletionPICO* completion);
typedef XrResult (XRAPI_PTR *PFN_xrGetSenseDataProviderStatePICO)(XrSenseDataProviderPICO provider, XrSenseDataProviderStatePICO* state);
typedef XrResult (XRAPI_PTR *PFN_xrQuerySenseDataAsyncPICO)(XrSenseDataProviderPICO provider, XrSenseDataQueryInfoPICO* queryInfo, XrFutureEXT* future);
typedef XrResult (XRAPI_PTR *PFN_xrQuerySenseDataCompletePICO)(XrSenseDataProviderPICO provider, XrFutureEXT future, XrSenseDataQueryCompletionPICO* completion);
typedef XrResult (XRAPI_PTR *PFN_xrDestroySenseDataSnapshotPICO)(XrSenseDataSnapshotPICO snapshot);
typedef XrResult (XRAPI_PTR *PFN_xrGetQueriedSenseDataPICO)(XrSenseDataProviderPICO provider, XrQueriedSenseDataGetInfoPICO* getInfo, XrQueriedSenseDataPICO* queriedSenseData);
...
typedef XrResult (XRAPI_PTR *PFN_xrRetrieveSpatialEntityAnchorPICO)(XrSenseDataSnapshotPICO snapshot, XrSpatialEntityAnchorRetrieveInfoPICO* retrieveInfo, XrAnchorPICO* anchor);
...
typedef XrResult (XRAPI_PTR *PFN_xrLocateAnchorPICO)(XrAnchorPICO anchor, XrAnchorLocateInfoPICO* locateInfo, XrSpaceLocation* location);
...
XRAPI_ATTR XrResult XRAPI_CALL xrGetSpatialEntityComponentDataPICO(
    XrSenseDataSnapshotPICO                     snapshot,
    XrSpatialEntityComponentGetInfoBaseHeaderPICO* getInfo,
    XrSpatialEntityComponentDataBaseHeaderPICO* componentData);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSenseDataProviderPICO(
    XrSession                                   session,
    XrSenseDataProviderCreateInfoBaseHeaderPICO* createInfo,
    XrSenseDataProviderPICO*                    provider);

XRAPI_ATTR XrResult XRAPI_CALL xrStartSenseDataProviderAsyncPICO(
    XrSession                                   session,
    XrSenseDataProviderStartInfoPICO*           startInfo,
    XrFutureEXT*                                future);

XRAPI_ATTR XrResult XRAPI_CALL xrStartSenseDataProviderCompletePICO(
    XrSession                                   session,
    XrFutureEXT                                 future,
    XrSenseDataProviderStartCompletionPICO*     completion);

XRAPI_ATTR XrResult XRAPI_CALL xrGetSenseDataProviderStatePICO(
    XrSenseDataProviderPICO                     provider,
    XrSenseDataProviderStatePICO*               state);

XRAPI_ATTR XrResult XRAPI_CALL xrQuerySenseDataAsyncPICO(
    XrSenseDataProviderPICO                     provider,
    XrSenseDataQueryInfoPICO*                   queryInfo,
    XrFutureEXT*                                future);

XRAPI_ATTR XrResult XRAPI_CALL xrQuerySenseDataCompletePICO(
    XrSenseDataProviderPICO                     provider,
    XrFutureEXT                                 future,
    XrSenseDataQueryCompletionPICO*             completion);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroySenseDataSnapshotPICO(
    XrSenseDataSnapshotPICO                     snapshot);

XRAPI_ATTR XrResult XRAPI_CALL xrGetQueriedSenseDataPICO(
    XrSenseDataProviderPICO                     provider,
    XrQueriedSenseDataGetInfoPICO*              getInfo,
    XrQueriedSenseDataPICO*                     queriedSenseData);

XRAPI_ATTR XrResult XRAPI_CALL xrStopSenseDataProviderPICO(
    XrSenseDataProviderPICO                     provider);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroySenseDataProviderPICO(
    XrSenseDataProviderPICO                     provider);

XRAPI_ATTR XrResult XRAPI_CALL xrRetrieveSpatialEntityAnchorPICO(
    XrSenseDataSnapshotPICO                     snapshot,
    XrSpatialEntityAnchorRetrieveInfoPICO*      retrieveInfo,
    XrAnchorPICO*                               anchor);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroyAnchorPICO(
    XrAnchorPICO                                anchor);

XRAPI_ATTR XrResult XRAPI_CALL xrGetAnchorUuidPICO(
    XrAnchorPICO                                anchor,
    XrUuidEXT*                                  uuid);

XRAPI_ATTR XrResult XRAPI_CALL xrLocateAnchorPICO(
    XrAnchorPICO                                anchor,
...
// XR_PICO_spatial_anchor is a preprocessor guard. Do not pass it to API calls.
...
// XrSystemSpatialAnchorPropertiesPICO extends XrSystemProperties
...
typedef XrResult (XRAPI_PTR *PFN_xrCreateSpatialAnchorAsyncPICO)(XrSenseDataProviderPICO         provider, XrSpatialAnchorCreateInfoPICO*  info, XrFutureEXT*                    future);
typedef XrResult (XRAPI_PTR *PFN_xrCreateSpatialAnchorCompletePICO)(XrSenseDataProviderPICO                 provider, XrFutureEXT                             future, XrSpatialAnchorCreateCompletionPICO*    completion);
typedef XrResult (XRAPI_PTR *PFN_xrPersistSpatialAnchorAsyncPICO)(XrSenseDataProviderPICO          provider, XrSpatialAnchorPersistInfoPICO*  info, XrFutureEXT*                   future);
typedef XrResult (XRAPI_PTR *PFN_xrPersistSpatialAnchorCompletePICO)(XrSenseDataProviderPICO                 provider, XrFutureEXT                           future, XrSpatialAnchorPersistCompletionPICO*   completion);
typedef XrResult (XRAPI_PTR *PFN_xrUnpersistSpatialAnchorAsyncPICO)(XrSenseDataProviderPICO            provider, XrSpatialAnchorUnpersistInfoPICO*  info, XrFutureEXT*                     future);
typedef XrResult (XRAPI_PTR *PFN_xrUnpersistSpatialAnchorCompletePICO)(XrSenseDataProviderPICO                 provider, XrFutureEXT                             future, XrSpatialAnchorUnpersistCompletionPICO*   completion);
...
// XR_PICO_spatial_anchor_sharing is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_spatial_anchor_sharing 1
#define XR_PICO_spatial_anchor_sharing_SPEC_VERSION 1
#define XR_PICO_SPATIAL_ANCHOR_SHARING_EXTENSION_NAME "XR_PICO_spatial_anchor_sharing"
// XrSystemSpatialAnchorSharingPropertiesPICO extends XrSystemProperties
typedef struct XrSystemSpatialAnchorSharingPropertiesPICO {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrBool32              supportsSpatialAnchorSharing;
} XrSystemSpatialAnchorSharingPropertiesPICO;

typedef struct XrSpatialAnchorShareInfoPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrAnchorPICO                anchor;
} XrSpatialAnchorShareInfoPICO;

typedef struct XrSpatialAnchorShareCompletionPICO {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrResult              futureResult;
} XrSpatialAnchorShareCompletionPICO;

typedef struct XrSharedSpatialAnchorDownloadInfoPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrUuidEXT                   uuid;
} XrSharedSpatialAnchorDownloadInfoPICO;

typedef struct XrSharedSpatialAnchorDownloadCompletionPICO {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrResult              futureResult;
} XrSharedSpatialAnchorDownloadCompletionPICO;

typedef XrResult (XRAPI_PTR *PFN_xrShareSpatialAnchorAsyncPICO)(XrSenseDataProviderPICO         provider, XrSpatialAnchorShareInfoPICO*   info, XrFutureEXT*                  future);
typedef XrResult (XRAPI_PTR *PFN_xrShareSpatialAnchorCompletePICO)(XrSenseDataProviderPICO                 provider, XrFutureEXT                           future, XrSpatialAnchorShareCompletionPICO*     completion);
typedef XrResult (XRAPI_PTR *PFN_xrDownloadSharedSpatialAnchorAsyncPICO)(XrSenseDataProviderPICO          provider, XrSharedSpatialAnchorDownloadInfoPICO* info, XrFutureEXT*                   future);
typedef XrResult (XRAPI_PTR *PFN_xrDownloadSharedSpatialAnchorCompletePICO)(XrSenseDataProviderPICO                 provider, XrFutureEXT                           future, XrSharedSpatialAnchorDownloadCompletionPICO*  completion);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrShareSpatialAnchorAsyncPICO(
    XrSenseDataProviderPICO                     provider,
    XrSpatialAnchorShareInfoPICO*               info,
    XrFutureEXT*                                future);

XRAPI_ATTR XrResult XRAPI_CALL xrShareSpatialAnchorCompletePICO(
    XrSenseDataProviderPICO                     provider,
    XrFutureEXT                                 future,
    XrSpatialAnchorShareCompletionPICO*         completion);

XRAPI_ATTR XrResult XRAPI_CALL xrDownloadSharedSpatialAnchorAsyncPICO(
    XrSenseDataProviderPICO                     provider,
    XrSharedSpatialAnchorDownloadInfoPICO*      info,
    XrFutureEXT*                                future);

XRAPI_ATTR XrResult XRAPI_CALL xrDownloadSharedSpatialAnchorCompletePICO(
    XrSenseDataProviderPICO                     provider,
    XrFutureEXT                                 future,
    XrSharedSpatialAnchorDownloadCompletionPICO* completion);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */


// XR_PICO_scene_capture is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_scene_capture 1
#define XR_PICO_scene_capture_SPEC_VERSION 1
#define XR_PICO_SCENE_CAPTURE_EXTENSION_NAME "XR_PICO_scene_capture"
// XrSystemSceneCapturePropertiesPICO extends XrSystemProperties
typedef struct XrSystemSceneCapturePropertiesPICO {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrBool32              supportsSceneCapture;
} XrSystemSceneCapturePropertiesPICO;

typedef struct XrSenseDataProviderCreateInfoSceneCapturePICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
} XrSenseDataProviderCreateInfoSceneCapturePICO;

typedef struct XrSceneCaptureStartInfoPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
} XrSceneCaptureStartInfoPICO;

typedef struct XrSceneCaptureStartCompletionPICO {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrResult              futureResult;
} XrSceneCaptureStartCompletionPICO;

typedef XrResult (XRAPI_PTR *PFN_xrStartSceneCaptureAsyncPICO)(XrSenseDataProviderPICO         provider, XrSceneCaptureStartInfoPICO*  info, XrFutureEXT*                    future);
typedef XrResult (XRAPI_PTR *PFN_xrStartSceneCaptureCompletePICO)(XrSenseDataProviderPICO                 provider, XrFutureEXT                           future, XrSceneCaptureStartCompletionPICO*    completion);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrStartSceneCaptureAsyncPICO(
    XrSenseDataProviderPICO                     provider,
    XrSceneCaptureStartInfoPICO*                info,
    XrFutureEXT*                                future);

XRAPI_ATTR XrResult XRAPI_CALL xrStartSceneCaptureCompletePICO(
    XrSenseDataProviderPICO                     provider,
    XrFutureEXT                                 future,
    XrSceneCaptureStartCompletionPICO*          completion);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */


// XR_PICO_spatial_mesh is a preprocessor guard. Do not pass it to API calls.
...
// Flag bits for XrSpatialMeshConfigFlagsPICO
...
// XrSystemSpatialMeshPropertiesPICO extends XrSystemProperties
