...
#define XR_LIST_ENUM_XrResult(_) \
    ...
    _(XR_ERROR_VIRTUAL_BOUNDARY_TRIGGER_NODE_TYPE_UNSUPPORTED_PICO, -1010001000) \
    _(XR_ERROR_MOTION_TRACKER_TYPE_MISMATCH_PICO, -1010002000) \
    _(XR_ERROR_MOTION_TRACKER_COUNT_EXCEEDED_PICO, -1010002001) \
    _(XR_ERROR_MOTION_TRACKING_MODE_MISMATCH_PICO, -1010002002) \
    _(XR_ERROR_MOTION_TRACKER_ID_INVALID_PICO, -1010002003) \
    _(XR_ERROR_SECURE_MR_UNREGISTERED_HANDLE_PICO, -1010007000) \
    _(XR_ERROR_SECURE_MR_INVALID_PARAM_PICO, -1010007001) \
    _(XR_ERROR_SECURE_MR_PIPELINE_LOCKED_PICO, -1010007002) \
    _(XR_ERROR_SECURE_MR_USAGE_BEFORE_INIT_PICO, -1010007003) \
    _(XR_ERROR_SECURE_MR_OTHER_INTERNAL_ERROR_PICO, -1010007004) \
    _(XR_ERROR_EXPAND_TRACKER_ID_INVALID_PICO, -1010008000) \
    _(XR_ERROR_SPATIAL_SENSING_SERVICE_UNAVAILABLE_PICO, -1200389027) \
    _(XR_ERROR_SPATIAL_ANCHOR_SHARING_NETWORK_TIMEOUT_PICO, -1200391101) \
    _(XR_ERROR_SPATIAL_ANCHOR_SHARING_AUTHENTICATION_FAILURE_PICO, -1200391102) \
    _(XR_ERROR_SPATIAL_ANCHOR_SHARING_NETWORK_FAILURE_PICO, -1200391103) \
    _(XR_ERROR_SPATIAL_ANCHOR_SHARING_LOCALIZATION_FAIL_PICO, -1200391104) \
    _(XR_ERROR_SPATIAL_ANCHOR_SHARING_MAP_INSUFFICIENT_PICO, -1200391105) \
...
#define XR_LIST_ENUM_XrStructureType(_) \
    ...
    _(XR_TYPE_EVENT_DATA_MRC_STATUS_CHANGED_PICO, 1010000000) \
    _(XR_TYPE_MRC_SPACE_CREATE_INFO_PICO, 1010000001) \
    _(XR_TYPE_EXTERNAL_CAMERA_PARAMETER_PICO, 1010000002) \
    _(XR_TYPE_VIRTUAL_BOUNDARY_INFO_PICO, 1010001001) \
    _(XR_TYPE_VIRTUAL_BOUNDARY_STATUS_PICO, 1010001002) \
    _(XR_TYPE_VIRTUAL_BOUNDARY_TRIGGER_NODE_PICO, 1010001003) \
    _(XR_TYPE_VIRTUAL_BOUNDARY_TRIGGER_POINT_PICO, 1010001004) \
    _(XR_TYPE_VIRTUAL_BOUNDARY_TRIGGER_PICO, 1010001005) \
    _(XR_TYPE_MOTION_TRACKER_BATTERY_STATE_PICO, 1010002000) \
    _(XR_TYPE_MOTION_TRACKER_LOCATION_INFO_PICO, 1010002001) \
    _(XR_TYPE_MOTION_TRACKER_SPACE_LOCATION_PICO, 1010002002) \
    _(XR_TYPE_MOTION_TRACKER_SPACE_VELOCITY_PICO, 1010002003) \
    _(XR_TYPE_EVENT_DATA_REQUEST_MOTION_TRACKER_COMPLETE_PICO, 1010002004) \
    _(XR_TYPE_EVENT_DATA_MOTION_TRACKER_CONNECTION_STATE_CHANGED_PICO, 1010002005) \
    _(XR_TYPE_EVENT_DATA_MOTION_TRACKER_POWER_KEY_EVENT_PICO, 1010002006) \
    _(XR_TYPE_COMPOSITION_LAYER_FISHEYE_PICO, 1010003000) \
    _(XR_TYPE_LAYER_SETTINGS_PICO, 1010004000) \
    _(XR_TYPE_EYE_TRACKER_CREATE_INFO_PICO, 1010006000) \
    _(XR_TYPE_EYE_TRACKER_DATA_INFO_PICO, 1010006001) \
    _(XR_TYPE_EYE_TRACKER_DATA_PICO, 1010006002) \
    _(XR_TYPE_EYE_DATA_PICO, 1010006003) \
    _(XR_TYPE_SECURE_MR_FRAMEWORK_CREATE_INFO_PICO, 1010007000) \
    _(XR_TYPE_SECURE_MR_PIPELINE_CREATE_INFO_PICO, 1010007001) \
    _(XR_TYPE_SECURE_MR_OPERATOR_BASE_HEADER_PICO, 1010007002) \
    _(XR_TYPE_SECURE_MR_OPERATOR_CREATE_INFO_PICO, 1010007003) \
    _(XR_TYPE_SECURE_MR_OPERATOR_MODEL_PICO, 1010007004) \
    _(XR_TYPE_SECURE_MR_OPERATOR_UPDATE_GLTF_PICO, 1010007005) \
    _(XR_TYPE_SECURE_MR_OPERATOR_RENDER_TEXT_PICO, 1010007006) \
    _(XR_TYPE_SECURE_MR_OPERATOR_ARITHMETIC_COMPOSE_PICO, 1010007007) \
    _(XR_TYPE_SECURE_MR_OPERATOR_COMPARISON_PICO, 1010007008) \
    _(XR_TYPE_SECURE_MR_OPERATOR_NORMALIZE_PICO, 1010007009) \
    _(XR_TYPE_SECURE_MR_OPERATOR_NON_MAXIMUM_SUPPRESSION_PICO, 1010007010) \
    _(XR_TYPE_SECURE_MR_TENSOR_BUFFER_PICO, 1010007011) \
    _(XR_TYPE_SECURE_MR_TENSOR_CREATE_INFO_BASE_HEADER_PICO, 1010007012) \
    _(XR_TYPE_SECURE_MR_TENSOR_CREATE_INFO_SHAPE_PICO, 1010007013) \
    _(XR_TYPE_SECURE_MR_TENSOR_CREATE_INFO_GLTF_PICO, 1010007014) \
    _(XR_TYPE_SECURE_MR_OPERATOR_UV_TO_3D_PICO, 1010007015) \
    _(XR_TYPE_SECURE_MR_PIPELINE_EXECUTE_PARAMETER_PICO, 1010007016) \
    _(XR_TYPE_SECURE_MR_PIPELINE_IO_PAIR_PICO, 1010007017) \
    _(XR_TYPE_SECURE_MR_OPERATOR_IO_MAP_PICO, 1010007018) \
    _(XR_TYPE_SECURE_MR_OPERATOR_SORT_MATRIX_PICO, 1010007019) \
    _(XR_TYPE_SECURE_MR_OPERATOR_COLOR_CONVERT_PICO, 1010007020) \
    _(XR_TYPE_SECURE_MR_OPERATOR_JAVASCRIPT_PICO, 1010007021) \
    _(XR_TYPE_EXPAND_DEVICE_MOTOR_VIBRATE_PICO, 1010008000) \
    _(XR_TYPE_EXPAND_DEVICE_CUSTOM_DATA_PICO, 1010008001) \
    _(XR_TYPE_EXPAND_DEVICE_BATTERY_STATE_PICO, 1010008002) \
    _(XR_TYPE_EVENT_DATA_EXPAND_DEVICE_CONNECTION_STATE_CHANGED_PICO, 1010008004) \
    _(XR_TYPE_EVENT_DATA_EXPAND_DEVICE_BATTERY_STATE_CHANGED_PICO, 1010008005) \
    _(XR_TYPE_EVENT_DATA_EXPAND_DEVICE_CUSTOM_DATA_STATE_CHANGED_PICO, 1010008006) \
    _(XR_TYPE_BODY_BONE_LENGTH_PICO, 1010009001) \
    _(XR_TYPE_BODY_TRACKING_POSTURE_FLAGS_DATA_PICO, 1010009002) \
    _(XR_TYPE_BODY_JOINT_VELOCITIES_PICO, 1010009003) \
    _(XR_TYPE_BODY_JOINT_ACCELERATIONS_PICO, 1010009004) \
    _(XR_TYPE_BODY_TRACKING_STATE_PICO, 1010009005) \
    _(XR_TYPE_SYMMETRIC_FOV_REPROJECTION_VIEW_CONFIGURATION_PICO, 1010016000) \
    _(XR_TYPE_LAYER_COLOR_MATRIX_PICO, 1010026000) \
    _(XR_TYPE_READBACK_TENSOR_BUFFER_PICO, 1010027000) \
    _(XR_TYPE_CREATE_BUFFER_FROM_GLOBAL_TENSOR_COMPLETION_PICO, 1010027001) \
    _(XR_TYPE_CREATE_TEXTURE_FROM_GLOBAL_TENSOR_COMPLETION_PICO, 1010027002) \
    _(XR_TYPE_READBACK_TENSOR_TEXTURE_PICO, 1010027003) \
    _(XR_TYPE_READBACK_TEXTURE_IMAGE_BASE_PICO, 1010027004) \
    _(XR_TYPE_READBACK_TEXTURE_IMAGE_VULKAN_PICO, 1010028000) \
    _(XR_TYPE_READBACK_TEXTURE_IMAGE_OPENGL_PICO, 1010029000) \
    _(XR_TYPE_SYSTEM_SPATIAL_SENSING_PROPERTIES_PICO, 1200389000) \
    _(XR_TYPE_SPATIAL_ENTITY_LOCATION_GET_INFO_PICO, 1200389002) \
    _(XR_TYPE_SPATIAL_ENTITY_LOCATION_DATA_PICO, 1200389003) \
    _(XR_TYPE_SPATIAL_ENTITY_SEMANTIC_GET_INFO_PICO, 1200389004) \
    _(XR_TYPE_SPATIAL_ENTITY_SEMANTIC_DATA_PICO, 1200389005) \
    _(XR_TYPE_SPATIAL_ENTITY_BOUNDING_BOX_2D_GET_INFO_PICO, 1200389006) \
    _(XR_TYPE_SPATIAL_ENTITY_BOUNDING_BOX_2D_DATA_PICO, 1200389007) \
    _(XR_TYPE_SPATIAL_ENTITY_POLYGON_GET_INFO_PICO, 1200389008) \
    _(XR_TYPE_SPATIAL_ENTITY_POLYGON_DATA_PICO, 1200389009) \
    _(XR_TYPE_SPATIAL_ENTITY_BOUNDING_BOX_3D_GET_INFO_PICO, 1200389010) \
    _(XR_TYPE_SPATIAL_ENTITY_BOUNDING_BOX_3D_DATA_PICO, 1200389011) \
    _(XR_TYPE_SPATIAL_ENTITY_TRIANGLE_MESH_GET_INFO_PICO, 1200389012) \
    _(XR_TYPE_SPATIAL_ENTITY_TRIANGLE_MESH_DATA_PICO, 1200389013) \
    _(XR_TYPE_SENSE_DATA_PROVIDER_START_COMPLETION_PICO, 1200389014) \
    _(XR_TYPE_EVENT_DATA_SENSE_DATA_PROVIDER_STATE_CHANGED_PICO, 1200389015) \
    _(XR_TYPE_SENSE_DATA_FILTER_UUID_PICO, 1200389016) \
    _(XR_TYPE_SENSE_DATA_FILTER_SEMANTIC_PICO, 1200389017) \
    _(XR_TYPE_SENSE_DATA_QUERY_INFO_PICO, 1200389018) \
    _(XR_TYPE_SENSE_DATA_QUERY_COMPLETION_PICO, 1200389019) \
    _(XR_TYPE_QUERIED_SENSE_DATA_GET_INFO_PICO, 1200389020) \
    _(XR_TYPE_SPATIAL_ENTITY_STATE_PICO, 1200389021) \
    _(XR_TYPE_QUERIED_SENSE_DATA_PICO, 1200389022) \
    _(XR_TYPE_EVENT_DATA_SENSE_DATA_UPDATED_PICO, 1200389023) \
    _(XR_TYPE_SENSE_DATA_PROVIDER_START_INFO_PICO, 1200389024) \
    _(XR_TYPE_SPATIAL_ENTITY_ANCHOR_RETRIEVE_INFO_PICO, 1200389025) \
    _(XR_TYPE_ANCHOR_LOCATE_INFO_PICO, 1200389026) \
    _(XR_TYPE_FUTURE_POLL_RESULT_PROGRESS_PICO, 1200389028) \
    _(XR_TYPE_SYSTEM_SPATIAL_ANCHOR_PROPERTIES_PICO, 1200390000) \
    _(XR_TYPE_SENSE_DATA_PROVIDER_CREATE_INFO_SPATIAL_ANCHOR_PICO, 1200390001) \
    _(XR_TYPE_SPATIAL_ANCHOR_CREATE_INFO_PICO, 1200390002) \
    _(XR_TYPE_SPATIAL_ANCHOR_CREATE_COMPLETION_PICO, 1200390003) \
    _(XR_TYPE_SPATIAL_ANCHOR_PERSIST_INFO_PICO, 1200390004) \
    _(XR_TYPE_SPATIAL_ANCHOR_PERSIST_COMPLETION_PICO, 1200390005) \
    _(XR_TYPE_SPATIAL_ANCHOR_UNPERSIST_INFO_PICO, 1200390006) \
    _(XR_TYPE_SPATIAL_ANCHOR_UNPERSIST_COMPLETION_PICO, 1200390007) \
    _(XR_TYPE_SYSTEM_SPATIAL_ANCHOR_SHARING_PROPERTIES_PICO, 1200391000) \
    _(XR_TYPE_SPATIAL_ANCHOR_SHARE_INFO_PICO, 1200391001) \
    _(XR_TYPE_SPATIAL_ANCHOR_SHARE_COMPLETION_PICO, 1200391002) \
    _(XR_TYPE_SPATIAL_ANCHOR_DOWNLOAD_INFO_PICO, 1200391003) \
    _(XR_TYPE_SPATIAL_ANCHOR_DOWNLOAD_COMPLETION_PICO, 1200391004) \
    _(XR_TYPE_SYSTEM_SCENE_CAPTURE_PROPERTIES_PICO, 1200392000) \
    _(XR_TYPE_SCENE_CAPTURE_START_INFO_PICO, 1200392001) \
    _(XR_TYPE_SCENE_CAPTURE_START_COMPLETION_PICO, 1200392002) \
    _(XR_TYPE_SENSE_DATA_PROVIDER_CREATE_INFO_SCENE_CAPTURE_PICO, 1200392003) \
    _(XR_TYPE_SYSTEM_SPATIAL_MESH_PROPERTIES_PICO, 1200393000) \
    _(XR_TYPE_SENSE_DATA_PROVIDER_CREATE_INFO_SPATIAL_MESH_PICO, 1200393001) \
...
#define XR_LIST_ENUM_XrViewConfigurationType(_) \
    ...
    _(XR_VIEW_CONFIGURATION_TYPE_PRIMARY_STEREO_SYMMETRIC_FOV_REPROJECTION_PICO, 1010016000) \
...
#define XR_LIST_ENUM_XrReferenceSpaceType(_) \
    ...
    _(XR_REFERENCE_SPACE_TYPE_ALGORITHM_GLOBAL_PICO, 1010002000) \
...
#define XR_LIST_ENUM_XrObjectType(_) \
    ...
    _(XR_OBJECT_TYPE_EYE_TRACKER_PICO, 1010006000) \
    _(XR_OBJECT_TYPE_SECURE_MR_FRAMEWORK_PICO, 1010007000) \
    _(XR_OBJECT_TYPE_SECURE_MR_PIPELINE_PICO, 1010007001) \
    _(XR_OBJECT_TYPE_SECURE_MR_TENSOR_PICO, 1010007002) \
    _(XR_OBJECT_TYPE_SENSE_DATA_PROVIDER_PICO, 1200389000) \
    _(XR_OBJECT_TYPE_SENSE_DATA_SNAPSHOT_PICO, 1200389001) \
    _(XR_OBJECT_TYPE_ANCHOR_PICO, 1200389002) \
...
#define XR_LIST_ENUM_XrVirtualBoundaryModePICO(_) \
    _(XR_VIRTUAL_BOUNDARY_MODE_STATIONARY_PICO, 0) \
    _(XR_VIRTUAL_BOUNDARY_MODE_CUSTOM_PICO, 1) \
    _(XR_VIRTUAL_BOUNDARY_MODE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrVirtualBoundaryEdgeTypePICO(_) \
    _(XR_VIRTUAL_BOUNDARY_EDGE_TYPE_OUTER_CONTOUR_PICO, 0) \
    _(XR_VIRTUAL_BOUNDARY_EDGE_TYPE_INSCRIBED_RECTANGLE_PICO, 1) \
    _(XR_VIRTUAL_BOUNDARY_EDGE_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrVirtualBoundaryTriggerNodeTypePICO(_) \
    _(XR_VIRTUAL_BOUNDARY_TRIGGER_NODE_TYPE_LEFT_HAND_PICO, 0) \
    _(XR_VIRTUAL_BOUNDARY_TRIGGER_NODE_TYPE_RIGHT_HAND_PICO, 1) \
    _(XR_VIRTUAL_BOUNDARY_TRIGGER_NODE_TYPE_HEAD_PICO, 2) \
    _(XR_VIRTUAL_BOUNDARY_TRIGGER_NODE_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrMotionTrackerConnectionStatePICO(_) \
    _(XR_MOTION_TRACKER_CONNECTION_STATE_DISCONNECTED_PICO, 0) \
    _(XR_MOTION_TRACKER_CONNECTION_STATE_CONNECTED_PICO, 1) \
    _(XR_MOTION_TRACKER_CONNECTION_STATE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrMotionTrackerChargingStatePICO(_) \
    _(XR_MOTION_TRACKER_CHARGING_STATE_UNCHARGED_PICO, 0) \
    _(XR_MOTION_TRACKER_CHARGING_STATE_TRICKLE_CHARGING_PICO, 1) \
    _(XR_MOTION_TRACKER_CHARGING_STATE_CHARGING_PICO, 2) \
    _(XR_MOTION_TRACKER_CHARGING_STATE_CHARGE_COMPLETED_PICO, 3) \
    _(XR_MOTION_TRACKER_CHARGING_STATE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSecureMrOperatorTypePICO(_) \
    _(XR_SECURE_MR_OPERATOR_TYPE_UNKNOWN_PICO, 0) \
    _(XR_SECURE_MR_OPERATOR_TYPE_ARITHMETIC_COMPOSE_PICO, 1) \
    _(XR_SECURE_MR_OPERATOR_TYPE_ELEMENTWISE_MIN_PICO, 4) \
    _(XR_SECURE_MR_OPERATOR_TYPE_ELEMENTWISE_MAX_PICO, 5) \
    _(XR_SECURE_MR_OPERATOR_TYPE_ELEMENTWISE_MULTIPLY_PICO, 6) \
    _(XR_SECURE_MR_OPERATOR_TYPE_CUSTOMIZED_COMPARE_PICO, 7) \
    _(XR_SECURE_MR_OPERATOR_TYPE_ELEMENTWISE_OR_PICO, 8) \
    _(XR_SECURE_MR_OPERATOR_TYPE_ELEMENTWISE_AND_PICO, 9) \
    _(XR_SECURE_MR_OPERATOR_TYPE_ALL_PICO, 10) \
    _(XR_SECURE_MR_OPERATOR_TYPE_ANY_PICO, 11) \
    _(XR_SECURE_MR_OPERATOR_TYPE_NMS_PICO, 12) \
    _(XR_SECURE_MR_OPERATOR_TYPE_SOLVE_P_N_P_PICO, 13) \
    _(XR_SECURE_MR_OPERATOR_TYPE_GET_AFFINE_PICO, 14) \
    _(XR_SECURE_MR_OPERATOR_TYPE_APPLY_AFFINE_PICO, 15) \
    _(XR_SECURE_MR_OPERATOR_TYPE_APPLY_AFFINE_POINT_PICO, 16) \
    _(XR_SECURE_MR_OPERATOR_TYPE_UV_TO_3D_IN_CAM_SPACE_PICO, 17) \
    _(XR_SECURE_MR_OPERATOR_TYPE_ASSIGNMENT_PICO, 18) \
    _(XR_SECURE_MR_OPERATOR_TYPE_RUN_MODEL_INFERENCE_PICO, 19) \
    _(XR_SECURE_MR_OPERATOR_TYPE_NORMALIZE_PICO, 21) \
    _(XR_SECURE_MR_OPERATOR_TYPE_CAMERA_SPACE_TO_WORLD_PICO, 22) \
    _(XR_SECURE_MR_OPERATOR_TYPE_RECTIFIED_VST_ACCESS_PICO, 23) \
    _(XR_SECURE_MR_OPERATOR_TYPE_ARGMAX_PICO, 24) \
    _(XR_SECURE_MR_OPERATOR_TYPE_CONVERT_COLOR_PICO, 25) \
    _(XR_SECURE_MR_OPERATOR_TYPE_SORT_VEC_PICO, 26) \
    _(XR_SECURE_MR_OPERATOR_TYPE_INVERSION_PICO, 27) \
    _(XR_SECURE_MR_OPERATOR_TYPE_GET_TRANSFORM_MAT_PICO, 28) \
    _(XR_SECURE_MR_OPERATOR_TYPE_SORT_MAT_PICO, 29) \
    _(XR_SECURE_MR_OPERATOR_TYPE_SWITCH_GLTF_RENDER_STATUS_PICO, 30) \
    _(XR_SECURE_MR_OPERATOR_TYPE_UPDATE_GLTF_PICO, 31) \
    _(XR_SECURE_MR_OPERATOR_TYPE_RENDER_TEXT_PICO, 32) \
    _(XR_SECURE_MR_OPERATOR_TYPE_LOAD_TEXTURE_PICO, 33) \
    _(XR_SECURE_MR_OPERATOR_TYPE_SVD_PICO, 34) \
    _(XR_SECURE_MR_OPERATOR_TYPE_NORM_PICO, 35) \
    _(XR_SECURE_MR_OPERATOR_TYPE_SWAP_HWC_CHW_PICO, 36) \
    _(XR_SECURE_MR_OPERATOR_TYPE_JAVASCRIPT_PICO, 39) \
    _(XR_SECURE_MROPERATOR_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSecureMrModelEncodingPICO(_) \
    _(XR_SECURE_MR_MODEL_ENCODING_FLOAT_32_PICO, 1) \
    _(XR_SECURE_MR_MODEL_ENCODING_UFIXED_POINT8_PICO, 2) \
    _(XR_SECURE_MR_MODEL_ENCODING_SFIXED_POINT8_PICO, 3) \
    _(XR_SECURE_MR_MODEL_ENCODING_UFIXED_POINT16_PICO, 4) \
    _(XR_SECURE_MR_MODEL_ENCODING_INT32_PICO, 5) \
    _(XR_SECURE_MRMODEL_ENCODING_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSecureMrModelTypePICO(_) \
    _(XR_SECURE_MR_MODEL_TYPE_QNN_CONTEXT_BINARY_PICO, 1) \
    _(XR_SECURE_MRMODEL_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSecureMrGltfOperatorAttributePICO(_) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_TEXTURE_PICO, 1) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_ANIMATION_PICO, 2) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_WORLD_POSE_PICO, 3) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_LOCAL_TRANSFORM_PICO, 4) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_MATERIAL_METALLIC_FACTOR_PICO, 5) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_MATERIAL_ROUGHNESS_FACTOR_PICO, 6) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_MATERIAL_OCCLUSION_MAP_TEXTURE_PICO, 7) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_MATERIAL_BASE_COLOR_FACTOR_PICO, 8) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_MATERIAL_EMISSIVE_FACTOR_PICO, 9) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_MATERIAL_EMISSIVE_STRENGTH_PICO, 10) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_MATERIAL_EMISSIVE_TEXTURE_PICO, 11) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_MATERIAL_BASE_COLOR_TEXTURE_PICO, 12) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_MATERIAL_NORMAL_MAP_TEXTURE_PICO, 13) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_MATERIAL_METALLIC_ROUGHNESS_TEXTURE_PICO, 14) \
    _(XR_SECURE_MRGLTF_OPERATOR_ATTRIBUTE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSecureMrFontTypefacePICO(_) \
    _(XR_SECURE_MR_FONT_TYPEFACE_DEFAULT_PICO, 1) \
    _(XR_SECURE_MR_FONT_TYPEFACE_SANS_SERIF_PICO, 2) \
    _(XR_SECURE_MR_FONT_TYPEFACE_SERIF_PICO, 3) \
    _(XR_SECURE_MR_FONT_TYPEFACE_MONOSPACE_PICO, 4) \
    _(XR_SECURE_MR_FONT_TYPEFACE_BOLD_PICO, 5) \
    _(XR_SECURE_MR_FONT_TYPEFACE_ITALIC_PICO, 6) \
    _(XR_SECURE_MRFONT_TYPEFACE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSecureMrNormalizeTypePICO(_) \
    _(XR_SECURE_MR_NORMALIZE_TYPE_L1_PICO, 1) \
    _(XR_SECURE_MR_NORMALIZE_TYPE_L2_PICO, 2) \
    _(XR_SECURE_MR_NORMALIZE_TYPE_INF_PICO, 3) \
    _(XR_SECURE_MR_NORMALIZE_TYPE_MINMAX_PICO, 4) \
    _(XR_SECURE_MRNORMALIZE_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSecureMrTensorDataTypePICO(_) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_UINT8_PICO, 1) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_INT8_PICO, 2) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_UINT16_PICO, 3) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_INT16_PICO, 4) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_INT32_PICO, 5) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_FLOAT32_PICO, 6) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_FLOAT64_PICO, 7) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_DYNAMIC_TEXTURE_UINT8_PICO, 8) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_DYNAMIC_TEXTURE_FLOAT32_PICO, 9) \
    _(XR_SECURE_MRTENSOR_DATA_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSecureMrTensorTypePICO(_) \
    _(XR_SECURE_MR_TENSOR_TYPE_POINT_PICO, 1) \
    _(XR_SECURE_MR_TENSOR_TYPE_SCALAR_PICO, 2) \
    _(XR_SECURE_MR_TENSOR_TYPE_SLICE_PICO, 3) \
    _(XR_SECURE_MR_TENSOR_TYPE_COLOR_PICO, 4) \
    _(XR_SECURE_MR_TENSOR_TYPE_TIMESTAMP_PICO, 5) \
    _(XR_SECURE_MR_TENSOR_TYPE_MAT_PICO, 6) \
    _(XR_SECURE_MR_TENSOR_TYPE_GLTF_PICO, 7) \
    _(XR_SECURE_MR_TENSOR_TYPE_MAT_DYNAMIC_TEXTURE_PICO, 8) \
    _(XR_SECURE_MRTENSOR_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSecureMrComparisonPICO(_) \
    _(XR_SECURE_MR_COMPARISON_UNKNOWN_PICO, 0) \
    _(XR_SECURE_MR_COMPARISON_LARGER_THAN_PICO, 1) \
    _(XR_SECURE_MR_COMPARISON_SMALLER_THAN_PICO, 2) \
    _(XR_SECURE_MR_COMPARISON_SMALLER_OR_EQUAL_PICO, 3) \
    _(XR_SECURE_MR_COMPARISON_LARGER_OR_EQUAL_PICO, 4) \
    _(XR_SECURE_MR_COMPARISON_EQUAL_TO_PICO, 5) \
    _(XR_SECURE_MR_COMPARISON_NOT_EQUAL_PICO, 6) \
    _(XR_SECURE_MRCOMPARISON_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSecureMrMatrixSortTypePICO(_) \
    _(XR_SECURE_MR_MATRIX_SORT_TYPE_COLUMN_PICO, 1) \
    _(XR_SECURE_MR_MATRIX_SORT_TYPE_ROW_PICO, 2) \
    _(XR_SECURE_MRMATRIX_SORT_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrExpandDeviceConnectionStatePICO(_) \
    _(XR_EXPAND_DEVICE_CONNECTION_STATE_DISCONNECTED_PICO, 0) \
    _(XR_EXPAND_DEVICE_CONNECTION_STATE_CONNECTED_PICO, 1) \
    _(XR_EXPAND_DEVICE_CONNECTION_STATE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrExpandDeviceChargingStatePICO(_) \
    _(XR_EXPAND_DEVICE_CHARGING_STATE_UNCHARGED_PICO, 0) \
    _(XR_EXPAND_DEVICE_CHARGING_STATE_TRICKLE_CHARGING_PICO, 1) \
    _(XR_EXPAND_DEVICE_CHARGING_STATE_CHARGING_PICO, 2) \
    _(XR_EXPAND_DEVICE_CHARGING_STATE_CHARGE_COMPLETED_PICO, 3) \
    _(XR_EXPAND_DEVICE_CHARGING_STATE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrExpandDeviceCustomDataStatePICO(_) \
    _(XR_EXPAND_DEVICE_CUSTOM_DATA_STATE_EMPTY_PICO, 0) \
    _(XR_EXPAND_DEVICE_CUSTOM_DATA_STATE_READY_PICO, 1) \
    _(XR_EXPAND_DEVICE_CUSTOM_DATA_STATE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrBodyTrackingPosturePICO(_) \
    _(XR_BODY_TRACKING_POSTURE_STOMP_PICO, 1) \
    _(XR_BODY_TRACKING_POSTURE_STATIC_PICO, 2) \
    _(XR_BODY_TRACKING_POSTURE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrBodyTrackingStatusPICO(_) \
    _(XR_BODY_TRACKING_STATUS_INVALID_PICO, 0) \
    _(XR_BODY_TRACKING_STATUS_VALID_PICO, 1) \
    _(XR_BODY_TRACKING_STATUS_LIMITED_PICO, 2) \
    _(XR_BODY_TRACKING_STATUS_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrBodyTrackingMessagePICO(_) \
    _(XR_BODY_TRACKING_MESSAGE_NO_ERROR_PICO, 0) \
    _(XR_BODY_TRACKING_MESSAGE_TRACKER_NOT_CALIBRATED_PICO, 1) \
    _(XR_BODY_TRACKING_MESSAGE_TRACKER_NUM_NOT_ENOUGH_PICO, 2) \
    _(XR_BODY_TRACKING_MESSAGE_TRACKER_STATE_NOT_SATISFIED_PICO, 3) \
    _(XR_BODY_TRACKING_MESSAGE_TRACKER_PERSISTENT_INVISIBILITY_PICO, 4) \
    _(XR_BODY_TRACKING_MESSAGE_TRACKER_DATA_ERROR_PICO, 5) \
    _(XR_BODY_TRACKING_MESSAGE_USER_CHANGE_PICO, 6) \
    _(XR_BODY_TRACKING_MESSAGE_TRACKING_POSE_ERROR_PICO, 7) \
    _(XR_BODY_TRACKING_MESSAGE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrAdaptiveResolutionSettingPICO(_) \
    _(XR_ADAPTIVE_RESOLUTION_SETTING_HIGH_QUALITY_PICO, 0) \
    _(XR_ADAPTIVE_RESOLUTION_SETTING_BALANCED_PICO, 1) \
    _(XR_ADAPTIVE_RESOLUTION_SETTING_POWER_SAVING_PICO, 2) \
    _(XR_ADAPTIVE_RESOLUTION_SETTING_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSpatialEntityComponentTypePICO(_) \
    _(XR_SPATIAL_ENTITY_COMPONENT_TYPE_LOCATION_PICO, 0) \
    _(XR_SPATIAL_ENTITY_COMPONENT_TYPE_SEMANTIC_PICO, 1) \
    _(XR_SPATIAL_ENTITY_COMPONENT_TYPE_BOUNDING_BOX_2D_PICO, 2) \
    _(XR_SPATIAL_ENTITY_COMPONENT_TYPE_POLYGON_PICO, 3) \
    _(XR_SPATIAL_ENTITY_COMPONENT_TYPE_BOUNDING_BOX_3D_PICO, 4) \
    _(XR_SPATIAL_ENTITY_COMPONENT_TYPE_TRIANGLE_MESH_PICO, 5) \
    _(XR_SPATIAL_ENTITY_COMPONENT_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSemanticLabelPICO(_) \
    _(XR_SEMANTIC_LABEL_UNKNOWN_PICO, 0) \
    _(XR_SEMANTIC_LABEL_FLOOR_PICO, 1) \
    _(XR_SEMANTIC_LABEL_CEILING_PICO, 2) \
    _(XR_SEMANTIC_LABEL_WALL_PICO, 3) \
    _(XR_SEMANTIC_LABEL_DOOR_PICO, 4) \
    _(XR_SEMANTIC_LABEL_WINDOW_PICO, 5) \
    _(XR_SEMANTIC_LABEL_OPENING_PICO, 6) \
    _(XR_SEMANTIC_LABEL_TABLE_PICO, 7) \
    _(XR_SEMANTIC_LABEL_SOFA_PICO, 8) \
    _(XR_SEMANTIC_LABEL_CHAIR_PICO, 9) \
    _(XR_SEMANTIC_LABEL_HUMAN_PICO, 10) \
    _(XR_SEMANTIC_LABEL_BEAM_PICO, 11) \
    _(XR_SEMANTIC_LABEL_COLUMN_PICO, 12) \
    _(XR_SEMANTIC_LABEL_CURTAIN_PICO, 13) \
    _(XR_SEMANTIC_LABEL_CABINET_PICO, 14) \
    _(XR_SEMANTIC_LABEL_BED_PICO, 15) \
    _(XR_SEMANTIC_LABEL_PLANT_PICO, 16) \
    _(XR_SEMANTIC_LABEL_SCREEN_PICO, 17) \
    _(XR_SEMANTIC_LABEL_VIRTUAL_WALL_PICO, 18) \
    _(XR_SEMANTIC_LABEL_REFRIGERATOR_PICO, 19) \
    _(XR_SEMANTIC_LABEL_WASHING_MACHINE_PICO, 20) \
    _(XR_SEMANTIC_LABEL_AIR_CONDITIONER_PICO, 21) \
    _(XR_SEMANTIC_LABEL_LAMP_PICO, 22) \
    _(XR_SEMANTIC_LABEL_WALL_ART_PICO, 23) \
    _(XR_SEMANTIC_LABEL_STAIRWAY_PICO, 24) \
    _(XR_SEMANTIC_LABEL_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSenseDataProviderStatePICO(_) \
    _(XR_SENSE_DATA_PROVIDER_STATE_INITIALIZED_PICO, 0) \
    _(XR_SENSE_DATA_PROVIDER_STATE_RUNNING_PICO, 1) \
    _(XR_SENSE_DATA_PROVIDER_STATE_STOPPED_PICO, 2) \
    _(XR_SENSE_DATA_PROVIDER_STATE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrPersistenceLocationPICO(_) \
    _(XR_PERSISTENCE_LOCATION_LOCAL_PICO, 0) \
    _(XR_PERSISTENCE_LOCATION_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSpatialMeshLodPICO(_) \
    _(XR_SPATIAL_MESH_LOD_COARSE_PICO, 0) \
    _(XR_SPATIAL_MESH_LOD_MEDIUM_PICO, 1) \
    _(XR_SPATIAL_MESH_LOD_FINE_PICO, 2) \
    _(XR_SPATIAL_MESH_LOD_MAX_ENUM_PICO, 0x7FFFFFFF)
...
#define XR_LIST_BITS_XrCompositionLayerFlags(_) \
    ...
    _(XR_COMPOSITION_LAYER_MRC_COMPOSITION_BIT_PICO, 0x40000000) \
    _(XR_COMPOSITION_LAYER_INVERTED_ALPHA_BIT_EXT, 0x00000008) \
    _(XR_COMPOSITION_LAYER_REPROJECTION_BIT_PICO, 0x80000000) \
...
#define XR_LIST_BITS_XrLayerSettingsFlagsPICO(_) \
    _(XR_LAYER_SETTINGS_FIXED_FOVEATED_NORMAL_SUPER_SAMPLING_BIT_PICO, 0x00000001) \
    _(XR_LAYER_SETTINGS_FIXED_FOVEATED_QUALITY_SUPER_SAMPLING_BIT_PICO, 0x00000002) \
    _(XR_LAYER_SETTINGS_FIXED_FOVEATED_NORMAL_SHARPENING_BIT_PICO, 0x00000004) \
    _(XR_LAYER_SETTINGS_FIXED_FOVEATED_QUALITY_SHARPENING_BIT_PICO, 0x00000008) \
    _(XR_LAYER_SETTINGS_SELF_ADAPTIVE_NORMAL_SHARPENING_BIT_PICO, 0x00000010) \
    _(XR_LAYER_SETTINGS_SELF_ADAPTIVE_QUALITY_SHARPENING_BIT_PICO, 0x00000020) \
    _(XR_LAYER_SETTINGS_SUPER_RESOLUTION_BIT_PICO, 0x00000040) \
    _(XR_LAYER_SETTINGS_NEUR_SUPER_RESOLUTION_BIT_PICO, 0x00000080) \

#define XR_LIST_BITS_XrEyeTrackerFlagsPICO(_) \
    _(XR_EYE_TRACKER_LEFT_BIT_PICO, 0x00000001) \
    _(XR_EYE_TRACKER_RIGHT_BIT_PICO, 0x00000002) \

#define XR_LIST_BITS_XrEyeTrackerTrackingStateFlagsPICO(_) \
    _(XR_EYE_TRACKER_TRACKING_STATE_LEFT_EYE_BIT_PICO, 0x00000001) \
    _(XR_EYE_TRACKER_TRACKING_STATE_RIGHT_EYE_BIT_PICO, 0x00000002) \

#define XR_LIST_BITS_XrSpaceAccelerationFlagsPICO(_) \
    _(XR_SPACE_ACCELERATION_LINEAR_VALID_BIT_PICO, 0x00000001) \
    _(XR_SPACE_ACCELERATION_ANGULAR_VALID_BIT_PICO, 0x00000002) \

#define XR_LIST_BITS_XrSpatialMeshConfigFlagsPICO(_) \
    _(XR_SPATIAL_MESH_CONFIG_SEMANTIC_BIT_PICO, 0x00000001) \
    _(XR_SPATIAL_MESH_CONFIG_ALIGN_SEMANTIC_WITH_VERTEX_BIT_PICO, 0x00000002) \
...
/// Calls your macro with the name of each member of XrEventDataMrcStatusChangedPICO, in order.
#define XR_LIST_STRUCT_XrEventDataMrcStatusChangedPICO(_) \
    _(type) \
    _(next) \
    _(mrcStatus) \

/// Calls your macro with the name of each member of XrMrcSpaceCreateInfoPICO, in order.
#define XR_LIST_STRUCT_XrMrcSpaceCreateInfoPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrExternalCameraParameterPICO, in order.
#define XR_LIST_STRUCT_XrExternalCameraParameterPICO(_) \
    _(type) \
    _(next) \
    _(width) \
    _(height) \
...
/// Calls your macro with the name of each member of XrVirtualBoundaryInfoPICO, in order.
#define XR_LIST_STRUCT_XrVirtualBoundaryInfoPICO(_) \
    _(type) \
    _(next) \
    _(baseSpace) \
    _(edgeType) \

/// Calls your macro with the name of each member of XrVirtualBoundaryTriggerBaseHeaderPICO, in order.
#define XR_LIST_STRUCT_XrVirtualBoundaryTriggerBaseHeaderPICO(_) \
    _(type) \
    _(next) \
    _(boundaryInfo) \

/// Calls your macro with the name of each member of XrVirtualBoundaryTriggerNodePICO, in order.
#define XR_LIST_STRUCT_XrVirtualBoundaryTriggerNodePICO(_) \
    _(type) \
    _(next) \
    _(boundaryInfo) \
    _(node) \

/// Calls your macro with the name of each member of XrVirtualBoundaryTriggerPointPICO, in order.
#define XR_LIST_STRUCT_XrVirtualBoundaryTriggerPointPICO(_) \
    _(type) \
    _(next) \
    _(boundaryInfo) \
    _(point) \

/// Calls your macro with the name of each member of XrVirtualBoundaryStatusPICO, in order.
#define XR_LIST_STRUCT_XrVirtualBoundaryStatusPICO(_) \
    _(type) \
    _(next) \
    _(isReady) \
    _(isEnabled) \
...
/// Calls your macro with the name of each member of XrVirtualBoundaryTriggerPICO, in order.
#define XR_LIST_STRUCT_XrVirtualBoundaryTriggerPICO(_) \
    _(type) \
    _(next) \
    _(isTriggering) \
    _(isValid) \
    _(closestDistance) \
    _(closestPoint) \
    _(closestPointNormal) \

/// Calls your macro with the name of each member of XrMotionTrackerSpaceVelocityPICO, in order.
#define XR_LIST_STRUCT_XrMotionTrackerSpaceVelocityPICO(_) \
    _(type) \
    _(next) \
    _(velocityFlags) \
    _(linearVelocity) \
...
/// Calls your macro with the name of each member of XrMotionTrackerSpaceLocationPICO, in order.
#define XR_LIST_STRUCT_XrMotionTrackerSpaceLocationPICO(_) \
    _(type) \
    _(next) \
    _(locationFlags) \
    _(pose) \

/// Calls your macro with the name of each member of XrEventDataRequestMotionTrackerCompletePICO, in order.
#define XR_LIST_STRUCT_XrEventDataRequestMotionTrackerCompletePICO(_) \
    _(type) \
    _(next) \
    _(trackerCount) \
    _(trackerIds) \
...
/// Calls your macro with the name of each member of XrEventDataMotionTrackerConnectionStateChangedPICO, in order.
#define XR_LIST_STRUCT_XrEventDataMotionTrackerConnectionStateChangedPICO(_) \
    _(type) \
    _(next) \
    _(trackerId) \
    _(state) \

/// Calls your macro with the name of each member of XrEventDataMotionTrackerPowerKeyEventPICO, in order.
#define XR_LIST_STRUCT_XrEventDataMotionTrackerPowerKeyEventPICO(_) \
    _(type) \
    _(next) \
    _(trackerId) \
    _(isLongClick) \

/// Calls your macro with the name of each member of XrMotionTrackerBatteryStatePICO, in order.
#define XR_LIST_STRUCT_XrMotionTrackerBatteryStatePICO(_) \
    _(type) \
    _(next) \
    _(batteryLevel) \
    _(chargingState) \

/// Calls your macro with the name of each member of XrMotionTrackerLocationInfoPICO, in order.
#define XR_LIST_STRUCT_XrMotionTrackerLocationInfoPICO(_) \
    _(type) \
    _(next) \
    _(baseSpace) \
    _(time) \

/// Calls your macro with the name of each member of XrCompositionLayerFisheyePICO, in order.
#define XR_LIST_STRUCT_XrCompositionLayerFisheyePICO(_) \
    _(type) \
    _(next) \
    _(layerFlags) \
    _(space) \
...
/// Calls your macro with the name of each member of XrLayerSettingsPICO, in order.
#define XR_LIST_STRUCT_XrLayerSettingsPICO(_) \
    _(type) \
    _(next) \
    _(layerFlags) \

/// Calls your macro with the name of each member of XrEyeTrackerCreateInfoPICO, in order.
#define XR_LIST_STRUCT_XrEyeTrackerCreateInfoPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrEyeTrackerDataInfoPICO, in order.
#define XR_LIST_STRUCT_XrEyeTrackerDataInfoPICO(_) \
    _(type) \
    _(next) \
    _(eyeTrackingFlags) \

/// Calls your macro with the name of each member of XrEyeDataPICO, in order.
#define XR_LIST_STRUCT_XrEyeDataPICO(_) \
    _(type) \
    _(next) \
    _(openness) \
    _(pupilDilation) \
...
/// Calls your macro with the name of each member of XrEyeTrackerDataPICO, in order.
#define XR_LIST_STRUCT_XrEyeTrackerDataPICO(_) \
    _(type) \
    _(next) \
    _(trackingState) \
    _(leftEyeData) \
...
/// Calls your macro with the name of each member of XrSecureMrFrameworkCreateInfoPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrFrameworkCreateInfoPICO(_) \
    _(type) \
    _(next) \
    _(width) \
    _(height) \

/// Calls your macro with the name of each member of XrSecureMrPipelineCreateInfoPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrPipelineCreateInfoPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrSecureMrOperatorBaseHeaderPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorBaseHeaderPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrSecureMrOperatorCreateInfoPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorCreateInfoPICO(_) \
    _(type) \
    _(next) \
    _(operatorInfo) \
    _(operatorType) \

/// Calls your macro with the name of each member of XrSecureMrOperatorIOMapPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorIOMapPICO(_) \
    _(type) \
    _(next) \
    _(encodingType) \
    _(nodeName) \
...
/// Calls your macro with the name of each member of XrSecureMrOperatorModelPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorModelPICO(_) \
    _(type) \
    _(next) \
    _(modelInputCount) \
    _(modelInputs) \
...
/// Calls your macro with the name of each member of XrSecureMrOperatorUpdateGltfPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorUpdateGltfPICO(_) \
    _(type) \
    _(next) \
    _(attribute) \

/// Calls your macro with the name of each member of XrSecureMrOperatorRenderTextPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorRenderTextPICO(_) \
    _(type) \
    _(next) \
    _(typeface) \
    _(languageAndLocale) \
...
/// Calls your macro with the name of each member of XrSecureMrOperatorArithmeticComposePICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorArithmeticComposePICO(_) \
    _(type) \
    _(next) \
    _(configText) \

/// Calls your macro with the name of each member of XrSecureMrOperatorNormalizePICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorNormalizePICO(_) \
    _(type) \
    _(next) \
    _(normalizeType) \

/// Calls your macro with the name of each member of XrSecureMrOperatorNonMaximumSuppressionPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorNonMaximumSuppressionPICO(_) \
    _(type) \
    _(next) \
    _(threshold) \

/// Calls your macro with the name of each member of XrSecureMrTensorBufferPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrTensorBufferPICO(_) \
    _(type) \
    _(next) \
    _(bufferSize) \
    _(buffer) \

/// Calls your macro with the name of each member of XrSecureMrTensorCreateInfoBaseHeaderPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrTensorCreateInfoBaseHeaderPICO(_) \
    _(type) \
    _(next) \
    _(placeHolder) \

/// Calls your macro with the name of each member of XrSecureMrTensorFormatPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrTensorFormatPICO(_) \
    _(dataType) \
    _(channel) \
    _(tensorType) \

/// Calls your macro with the name of each member of XrSecureMrTensorCreateInfoShapePICO, in order.
#define XR_LIST_STRUCT_XrSecureMrTensorCreateInfoShapePICO(_) \
    _(type) \
    _(next) \
    _(placeHolder) \
    _(dimensionsCount) \
...
/// Calls your macro with the name of each member of XrSecureMrTensorCreateInfoGltfPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrTensorCreateInfoGltfPICO(_) \
    _(type) \
    _(next) \
    _(placeHolder) \
    _(bufferSize) \
...
/// Calls your macro with the name of each member of XrSecureMrOperatorUVTo3DPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorUVTo3DPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrSecureMrPipelineIOPairPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrPipelineIOPairPICO(_) \
    _(type) \
    _(next) \
    _(localPlaceHolderTensor) \
    _(globalTensor) \

/// Calls your macro with the name of each member of XrSecureMrPipelineExecuteParameterPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrPipelineExecuteParameterPICO(_) \
    _(type) \
    _(next) \
    _(pipelineRunToBeWaited) \
    _(conditionTensor) \
    _(pairCount) \
    _(pipelineIOPair) \

/// Calls your macro with the name of each member of XrSecureMrOperatorComparisonPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorComparisonPICO(_) \
    _(type) \
    _(next) \
    _(comparison) \

/// Calls your macro with the name of each member of XrSecureMrOperatorSortMatrixPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorSortMatrixPICO(_) \
    _(type) \
    _(next) \
    _(sortType) \

/// Calls your macro with the name of each member of XrSecureMrOperatorColorConvertPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorColorConvertPICO(_) \
    _(type) \
    _(next) \
    _(convert) \

/// Calls your macro with the name of each member of XrSecureMrOperatorJavascriptPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorJavascriptPICO(_) \
    _(type) \
    _(next) \
    _(configText) \
    _(configLength) \

/// Calls your macro with the name of each member of XrExpandDeviceMotorVibratePICO, in order.
#define XR_LIST_STRUCT_XrExpandDeviceMotorVibratePICO(_) \
    _(type) \
    _(next) \
    _(duration) \
    _(frequency) \
...
/// Calls your macro with the name of each member of XrExpandDeviceCustomDataPICO, in order.
#define XR_LIST_STRUCT_XrExpandDeviceCustomDataPICO(_) \
    _(type) \
    _(next) \
    _(deviceId) \
    _(data) \

/// Calls your macro with the name of each member of XrExpandDeviceBatteryStatePICO, in order.
#define XR_LIST_STRUCT_XrExpandDeviceBatteryStatePICO(_) \
    _(type) \
    _(next) \
    _(batteryLevel) \
    _(chargingState) \

/// Calls your macro with the name of each member of XrEventDataExpandDeviceConnectionStateChangedPICO, in order.
#define XR_LIST_STRUCT_XrEventDataExpandDeviceConnectionStateChangedPICO(_) \
    _(type) \
    _(next) \
    _(deviceId) \
    _(connectionState) \

/// Calls your macro with the name of each member of XrEventDataExpandDeviceBatteryStateChangedPICO, in order.
#define XR_LIST_STRUCT_XrEventDataExpandDeviceBatteryStateChangedPICO(_) \
    _(type) \
    _(next) \
    _(deviceId) \
    _(batteryState) \

/// Calls your macro with the name of each member of XrEventDataExpandDeviceCustomDataStateChangedPICO, in order.
#define XR_LIST_STRUCT_XrEventDataExpandDeviceCustomDataStateChangedPICO(_) \
    _(type) \
    _(next) \
    _(dataState) \

/// Calls your macro with the name of each member of XrBodyBoneLengthPICO, in order.
#define XR_LIST_STRUCT_XrBodyBoneLengthPICO(_) \
    _(type) \
    _(next) \
    _(headBoneLength) \
    _(neckBoneLength) \
    ...
    _(lowerBoneLength) \
    _(footBoneLength) \
    _(shoulderBoneLength) \
    _(upperArmBoneLength) \
    _(lowerArmBoneLength) \
    _(handBoneLength) \

/// Calls your macro with the name of each member of XrBodyTrackingPostureFlagsDataPICO, in order.
#define XR_LIST_STRUCT_XrBodyTrackingPostureFlagsDataPICO(_) \
    _(type) \
    _(next) \
    _(jointCount) \
    _(postureFlag) \

/// Calls your macro with the name of each member of XrBodyJointVelocityPICO, in order.
#define XR_LIST_STRUCT_XrBodyJointVelocityPICO(_) \
    _(velocityFlags) \
    _(linearVelocity) \
    _(angularVelocity) \

/// Calls your macro with the name of each member of XrBodyJointVelocitiesPICO, in order.
#define XR_LIST_STRUCT_XrBodyJointVelocitiesPICO(_) \
    _(type) \
    _(next) \
    _(jointCount) \
    _(jointVelocities) \

/// Calls your macro with the name of each member of XrBodyJointAccelerationPICO, in order.
#define XR_LIST_STRUCT_XrBodyJointAccelerationPICO(_) \
    _(accelerationFlags) \
    _(linearAcceleration) \
    _(angularAcceleration) \

/// Calls your macro with the name of each member of XrBodyJointAccelerationsPICO, in order.
#define XR_LIST_STRUCT_XrBodyJointAccelerationsPICO(_) \
    _(type) \
    _(next) \
    _(jointCount) \
    _(jointAccelerations) \

/// Calls your macro with the name of each member of XrBodyTrackingStatePICO, in order.
#define XR_LIST_STRUCT_XrBodyTrackingStatePICO(_) \
    _(type) \
    _(next) \
    _(status) \
    _(message) \

/// Calls your macro with the name of each member of XrSymmetricFovReprojectionViewConfigurationPICO, in order.
#define XR_LIST_STRUCT_XrSymmetricFovReprojectionViewConfigurationPICO(_) \
    _(type) \
    _(next) \
    _(recommendedSymmetricFovImageRectWidth) \
    _(recommendedNotRenderingImageRectWidth) \

/// Calls your macro with the name of each member of XrColorMatrix3x3fPICO, in order.
#define XR_LIST_STRUCT_XrColorMatrix3x3fPICO(_) \
    _(m) \

/// Calls your macro with the name of each member of XrLayerColorMatrixPICO, in order.
#define XR_LIST_STRUCT_XrLayerColorMatrixPICO(_) \
    _(type) \
    _(next) \
    _(matrix) \

/// Calls your macro with the name of each member of XrReadbackTensorBufferPICO, in order.
#define XR_LIST_STRUCT_XrReadbackTensorBufferPICO(_) \
    _(type) \
    _(next) \
    _(bufferCapacityInput) \
    _(bufferSizeOutput) \
...
/// Calls your macro with the name of each member of XrCreateBufferFromGlobalTensorCompletionPICO, in order.
#define XR_LIST_STRUCT_XrCreateBufferFromGlobalTensorCompletionPICO(_) \
    _(type) \
    _(next) \
    _(futureResult) \
    _(tensorBuffer) \

/// Calls your macro with the name of each member of XrCreateTextureFromGlobalTensorCompletionPICO, in order.
#define XR_LIST_STRUCT_XrCreateTextureFromGlobalTensorCompletionPICO(_) \
    _(type) \
    _(next) \
    _(futureResult) \
    _(texture) \

/// Calls your macro with the name of each member of XrReadbackTextureImageBasePICO, in order.
#define XR_LIST_STRUCT_XrReadbackTextureImageBasePICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrReadbackTextureImageVulkanPICO, in order.
#define XR_LIST_STRUCT_XrReadbackTextureImageVulkanPICO(_) \
    _(type) \
    _(next) \
    _(image) \

/// Calls your macro with the name of each member of XrReadbackTextureImageOpenGLPICO, in order.
#define XR_LIST_STRUCT_XrReadbackTextureImageOpenGLPICO(_) \
    _(type) \
    _(next) \
    _(texId) \

/// Calls your macro with the name of each member of XrSystemSpatialSensingPropertiesPICO, in order.
#define XR_LIST_STRUCT_XrSystemSpatialSensingPropertiesPICO(_) \
    _(type) \
    _(next) \
    _(supportsSpatialSensing) \

/// Calls your macro with the name of each member of XrSpatialEntityComponentGetInfoBaseHeaderPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityComponentGetInfoBaseHeaderPICO(_) \
    _(type) \
    _(next) \
    _(entity) \
    _(componentType) \

/// Calls your macro with the name of each member of XrSpatialEntityComponentDataBaseHeaderPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityComponentDataBaseHeaderPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrSpatialEntityLocationGetInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityLocationGetInfoPICO(_) \
    _(type) \
    _(next) \
    _(entity) \
    _(componentType) \
...
/// Calls your macro with the name of each member of XrSpatialEntityLocationDataPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityLocationDataPICO(_) \
    _(type) \
    _(next) \
    _(location) \

/// Calls your macro with the name of each member of XrSpatialEntitySemanticGetInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntitySemanticGetInfoPICO(_) \
    _(type) \
    _(next) \
    _(entity) \
    _(componentType) \

/// Calls your macro with the name of each member of XrSpatialEntitySemanticDataPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntitySemanticDataPICO(_) \
    _(type) \
    _(next) \
    _(semanticCapacityInput) \
    _(semanticCountOutput) \
    _(semanticLabels) \

/// Calls your macro with the name of each member of XrSpatialEntityBoundingBox2DGetInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityBoundingBox2DGetInfoPICO(_) \
    _(type) \
    _(next) \
    _(entity) \
    _(componentType) \

/// Calls your macro with the name of each member of XrSpatialEntityBoundingBox2DDataPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityBoundingBox2DDataPICO(_) \
    _(type) \
    _(next) \
    _(boundingBox2D) \

/// Calls your macro with the name of each member of XrSpatialEntityPolygonGetInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityPolygonGetInfoPICO(_) \
    _(type) \
    _(next) \
    _(entity) \
    _(componentType) \

/// Calls your macro with the name of each member of XrSpatialEntityPolygonDataPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityPolygonDataPICO(_) \
    _(type) \
    _(next) \
    _(polygonCapacityInput) \
    _(polygonCountOutput) \
    _(polygonVertices) \

/// Calls your macro with the name of each member of XrSpatialEntityBoundingBox3DGetInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityBoundingBox3DGetInfoPICO(_) \
    _(type) \
    _(next) \
    _(entity) \
    _(componentType) \

/// Calls your macro with the name of each member of XrSpatialEntityBoundingBox3DDataPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityBoundingBox3DDataPICO(_) \
    _(type) \
    _(next) \
    _(boundingBox3D) \

/// Calls your macro with the name of each member of XrSpatialEntityTriangleMeshGetInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityTriangleMeshGetInfoPICO(_) \
    _(type) \
    _(next) \
    _(entity) \
    _(componentType) \

/// Calls your macro with the name of each member of XrSpatialEntityTriangleMeshDataPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityTriangleMeshDataPICO(_) \
    _(type) \
    _(next) \
    _(vertexCapacityInput) \
    _(vertexCountOutput) \
...
/// Calls your macro with the name of each member of XrSenseDataProviderCreateInfoBaseHeaderPICO, in order.
#define XR_LIST_STRUCT_XrSenseDataProviderCreateInfoBaseHeaderPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrSenseDataProviderStartInfoPICO, in order.
#define XR_LIST_STRUCT_XrSenseDataProviderStartInfoPICO(_) \
    _(type) \
    _(next) \
    _(provider) \

/// Calls your macro with the name of each member of XrSenseDataProviderStartCompletionPICO, in order.
#define XR_LIST_STRUCT_XrSenseDataProviderStartCompletionPICO(_) \
    _(type) \
    _(next) \
    _(futureResult) \

/// Calls your macro with the name of each member of XrEventDataSenseDataProviderStateChangedPICO, in order.
#define XR_LIST_STRUCT_XrEventDataSenseDataProviderStateChangedPICO(_) \
    _(type) \
    _(next) \
    _(provider) \
    _(newState) \

/// Calls your macro with the name of each member of XrEventDataSenseDataUpdatedPICO, in order.
#define XR_LIST_STRUCT_XrEventDataSenseDataUpdatedPICO(_) \
    _(type) \
    _(next) \
    _(provider) \

/// Calls your macro with the name of each member of XrSenseDataFilterBaseHeaderPICO, in order.
#define XR_LIST_STRUCT_XrSenseDataFilterBaseHeaderPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrSenseDataQueryInfoPICO, in order.
#define XR_LIST_STRUCT_XrSenseDataQueryInfoPICO(_) \
    _(type) \
    _(next) \
    _(filter) \

/// Calls your macro with the name of each member of XrSenseDataQueryCompletionPICO, in order.
#define XR_LIST_STRUCT_XrSenseDataQueryCompletionPICO(_) \
    _(type) \
    _(next) \
    _(futureResult) \
    _(snapshot) \

/// Calls your macro with the name of each member of XrQueriedSenseDataGetInfoPICO, in order.
#define XR_LIST_STRUCT_XrQueriedSenseDataGetInfoPICO(_) \
    _(type) \
    _(next) \
    _(snapshot) \

/// Calls your macro with the name of each member of XrSpatialEntityStatePICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityStatePICO(_) \
    _(type) \
    _(next) \
    _(entity) \
    _(lastUpdateTime) \
...
/// Calls your macro with the name of each member of XrQueriedSenseDataPICO, in order.
#define XR_LIST_STRUCT_XrQueriedSenseDataPICO(_) \
    _(type) \
    _(next) \
    _(spatialEntityCapacityInput) \
    _(spatialEntityCountOutput) \
    _(spatialEntities) \

/// Calls your macro with the name of each member of XrSenseDataFilterUuidPICO, in order.
#define XR_LIST_STRUCT_XrSenseDataFilterUuidPICO(_) \
    _(type) \
    _(next) \
    _(uuidCount) \
    _(uuids) \

/// Calls your macro with the name of each member of XrSenseDataFilterSemanticPICO, in order.
#define XR_LIST_STRUCT_XrSenseDataFilterSemanticPICO(_) \
    _(type) \
    _(next) \
    _(semanticCount) \
    _(semantics) \

/// Calls your macro with the name of each member of XrSpatialEntityAnchorRetrieveInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityAnchorRetrieveInfoPICO(_) \
    _(type) \
    _(next) \
    _(entity) \

/// Calls your macro with the name of each member of XrAnchorLocateInfoPICO, in order.
#define XR_LIST_STRUCT_XrAnchorLocateInfoPICO(_) \
    _(type) \
    _(next) \
    _(baseSpace) \
    _(time) \

/// Calls your macro with the name of each member of XrFuturePollResultProgressPICO, in order.
#define XR_LIST_STRUCT_XrFuturePollResultProgressPICO(_) \
    _(type) \
    _(next) \
    _(progress) \

/// Calls your macro with the name of each member of XrSystemSpatialAnchorPropertiesPICO, in order.
#define XR_LIST_STRUCT_XrSystemSpatialAnchorPropertiesPICO(_) \
    _(type) \
    _(next) \
    _(supportsSpatialAnchor) \

/// Calls your macro with the name of each member of XrSenseDataProviderCreateInfoSpatialAnchorPICO, in order.
#define XR_LIST_STRUCT_XrSenseDataProviderCreateInfoSpatialAnchorPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrSpatialAnchorCreateInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialAnchorCreateInfoPICO(_) \
    _(type) \
    _(next) \
    _(space) \
    _(pose) \
...
/// Calls your macro with the name of each member of XrSpatialAnchorCreateCompletionPICO, in order.
#define XR_LIST_STRUCT_XrSpatialAnchorCreateCompletionPICO(_) \
    _(type) \
    _(next) \
    _(futureResult) \
    _(anchor) \
...
/// Calls your macro with the name of each member of XrSpatialAnchorPersistInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialAnchorPersistInfoPICO(_) \
    _(type) \
    _(next) \
    _(location) \
    _(anchor) \

/// Calls your macro with the name of each member of XrSpatialAnchorPersistCompletionPICO, in order.
#define XR_LIST_STRUCT_XrSpatialAnchorPersistCompletionPICO(_) \
    _(type) \
    _(next) \
    _(futureResult) \
    _(anchor) \
...
/// Calls your macro with the name of each member of XrSpatialAnchorUnpersistInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialAnchorUnpersistInfoPICO(_) \
    _(type) \
    _(next) \
    _(location) \
    _(anchor) \

/// Calls your macro with the name of each member of XrSpatialAnchorUnpersistCompletionPICO, in order.
#define XR_LIST_STRUCT_XrSpatialAnchorUnpersistCompletionPICO(_) \
    _(type) \
    _(next) \
    _(futureResult) \
    _(anchor) \
...
/// Calls your macro with the name of each member of XrSystemSpatialAnchorSharingPropertiesPICO, in order.
#define XR_LIST_STRUCT_XrSystemSpatialAnchorSharingPropertiesPICO(_) \
    _(type) \
    _(next) \
    _(supportsSpatialAnchorSharing) \

/// Calls your macro with the name of each member of XrSpatialAnchorShareInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialAnchorShareInfoPICO(_) \
    _(type) \
    _(next) \
    _(anchor) \

/// Calls your macro with the name of each member of XrSpatialAnchorShareCompletionPICO, in order.
#define XR_LIST_STRUCT_XrSpatialAnchorShareCompletionPICO(_) \
    _(type) \
    _(next) \
    _(futureResult) \

/// Calls your macro with the name of each member of XrSharedSpatialAnchorDownloadInfoPICO, in order.
#define XR_LIST_STRUCT_XrSharedSpatialAnchorDownloadInfoPICO(_) \
    _(type) \
    _(next) \
    _(uuid) \

/// Calls your macro with the name of each member of XrSharedSpatialAnchorDownloadCompletionPICO, in order.
#define XR_LIST_STRUCT_XrSharedSpatialAnchorDownloadCompletionPICO(_) \
    _(type) \
    _(next) \
    _(futureResult) \

/// Calls your macro with the name of each member of XrSystemSceneCapturePropertiesPICO, in order.
#define XR_LIST_STRUCT_XrSystemSceneCapturePropertiesPICO(_) \
    _(type) \
    _(next) \
    _(supportsSceneCapture) \

/// Calls your macro with the name of each member of XrSenseDataProviderCreateInfoSceneCapturePICO, in order.
#define XR_LIST_STRUCT_XrSenseDataProviderCreateInfoSceneCapturePICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrSceneCaptureStartInfoPICO, in order.
#define XR_LIST_STRUCT_XrSceneCaptureStartInfoPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrSceneCaptureStartCompletionPICO, in order.
#define XR_LIST_STRUCT_XrSceneCaptureStartCompletionPICO(_) \
    _(type) \
    _(next) \
    _(futureResult) \

/// Calls your macro with the name of each member of XrSystemSpatialMeshPropertiesPICO, in order.
#define XR_LIST_STRUCT_XrSystemSpatialMeshPropertiesPICO(_) \
    _(type) \
    _(next) \
    _(supportsSpatialMesh) \

/// Calls your macro with the name of each member of XrSenseDataProviderCreateInfoSpatialMeshPICO, in order.
#define XR_LIST_STRUCT_XrSenseDataProviderCreateInfoSpatialMeshPICO(_) \
    _(type) \
    _(next) \
    _(configFlags) \
    _(lod) \
...
#define XR_LIST_STRUCTURE_TYPES_CORE(_) \
    ...
    _(XrEventDataMrcStatusChangedPICO, XR_TYPE_EVENT_DATA_MRC_STATUS_CHANGED_PICO) \
    _(XrMrcSpaceCreateInfoPICO, XR_TYPE_MRC_SPACE_CREATE_INFO_PICO) \
    _(XrExternalCameraParameterPICO, XR_TYPE_EXTERNAL_CAMERA_PARAMETER_PICO) \
    _(XrVirtualBoundaryInfoPICO, XR_TYPE_VIRTUAL_BOUNDARY_INFO_PICO) \
    _(XrVirtualBoundaryTriggerNodePICO, XR_TYPE_VIRTUAL_BOUNDARY_TRIGGER_NODE_PICO) \
    _(XrVirtualBoundaryTriggerPointPICO, XR_TYPE_VIRTUAL_BOUNDARY_TRIGGER_POINT_PICO) \
    _(XrVirtualBoundaryStatusPICO, XR_TYPE_VIRTUAL_BOUNDARY_STATUS_PICO) \
    _(XrVirtualBoundaryTriggerPICO, XR_TYPE_VIRTUAL_BOUNDARY_TRIGGER_PICO) \
    _(XrMotionTrackerSpaceVelocityPICO, XR_TYPE_MOTION_TRACKER_SPACE_VELOCITY_PICO) \
    _(XrMotionTrackerSpaceLocationPICO, XR_TYPE_MOTION_TRACKER_SPACE_LOCATION_PICO) \
    _(XrEventDataRequestMotionTrackerCompletePICO, XR_TYPE_EVENT_DATA_REQUEST_MOTION_TRACKER_COMPLETE_PICO) \
    _(XrEventDataMotionTrackerConnectionStateChangedPICO, XR_TYPE_EVENT_DATA_MOTION_TRACKER_CONNECTION_STATE_CHANGED_PICO) \
    _(XrEventDataMotionTrackerPowerKeyEventPICO, XR_TYPE_EVENT_DATA_MOTION_TRACKER_POWER_KEY_EVENT_PICO) \
    _(XrMotionTrackerBatteryStatePICO, XR_TYPE_MOTION_TRACKER_BATTERY_STATE_PICO) \
    _(XrMotionTrackerLocationInfoPICO, XR_TYPE_MOTION_TRACKER_LOCATION_INFO_PICO) \
    _(XrCompositionLayerFisheyePICO, XR_TYPE_COMPOSITION_LAYER_FISHEYE_PICO) \
    _(XrLayerSettingsPICO, XR_TYPE_LAYER_SETTINGS_PICO) \
    _(XrEyeTrackerCreateInfoPICO, XR_TYPE_EYE_TRACKER_CREATE_INFO_PICO) \
    _(XrEyeTrackerDataInfoPICO, XR_TYPE_EYE_TRACKER_DATA_INFO_PICO) \
    _(XrEyeDataPICO, XR_TYPE_EYE_DATA_PICO) \
    _(XrEyeTrackerDataPICO, XR_TYPE_EYE_TRACKER_DATA_PICO) \
    _(XrSecureMrFrameworkCreateInfoPICO, XR_TYPE_SECURE_MR_FRAMEWORK_CREATE_INFO_PICO) \
    _(XrSecureMrPipelineCreateInfoPICO, XR_TYPE_SECURE_MR_PIPELINE_CREATE_INFO_PICO) \
    _(XrSecureMrOperatorCreateInfoPICO, XR_TYPE_SECURE_MR_OPERATOR_CREATE_INFO_PICO) \
    _(XrSecureMrOperatorIOMapPICO, XR_TYPE_SECURE_MR_OPERATOR_IO_MAP_PICO) \
    _(XrSecureMrOperatorModelPICO, XR_TYPE_SECURE_MR_OPERATOR_MODEL_PICO) \
    _(XrSecureMrOperatorUpdateGltfPICO, XR_TYPE_SECURE_MR_OPERATOR_UPDATE_GLTF_PICO) \
    _(XrSecureMrOperatorRenderTextPICO, XR_TYPE_SECURE_MR_OPERATOR_RENDER_TEXT_PICO) \
    _(XrSecureMrOperatorArithmeticComposePICO, XR_TYPE_SECURE_MR_OPERATOR_ARITHMETIC_COMPOSE_PICO) \
    _(XrSecureMrOperatorNormalizePICO, XR_TYPE_SECURE_MR_OPERATOR_NORMALIZE_PICO) \
    _(XrSecureMrOperatorNonMaximumSuppressionPICO, XR_TYPE_SECURE_MR_OPERATOR_NON_MAXIMUM_SUPPRESSION_PICO) \
    _(XrSecureMrTensorBufferPICO, XR_TYPE_SECURE_MR_TENSOR_BUFFER_PICO) \
    _(XrSecureMrTensorCreateInfoShapePICO, XR_TYPE_SECURE_MR_TENSOR_CREATE_INFO_SHAPE_PICO) \
    _(XrSecureMrTensorCreateInfoGltfPICO, XR_TYPE_SECURE_MR_TENSOR_CREATE_INFO_GLTF_PICO) \
    _(XrSecureMrOperatorUVTo3DPICO, XR_TYPE_SECURE_MR_OPERATOR_UV_TO_3D_PICO) \
    _(XrSecureMrPipelineIOPairPICO, XR_TYPE_SECURE_MR_PIPELINE_IO_PAIR_PICO) \
    _(XrSecureMrPipelineExecuteParameterPICO, XR_TYPE_SECURE_MR_PIPELINE_EXECUTE_PARAMETER_PICO) \
    _(XrSecureMrOperatorComparisonPICO, XR_TYPE_SECURE_MR_OPERATOR_COMPARISON_PICO) \
    _(XrSecureMrOperatorSortMatrixPICO, XR_TYPE_SECURE_MR_OPERATOR_SORT_MATRIX_PICO) \
    _(XrSecureMrOperatorColorConvertPICO, XR_TYPE_SECURE_MR_OPERATOR_COLOR_CONVERT_PICO) \
    _(XrSecureMrOperatorJavascriptPICO, XR_TYPE_SECURE_MR_OPERATOR_JAVASCRIPT_PICO) \
    _(XrExpandDeviceMotorVibratePICO, XR_TYPE_EXPAND_DEVICE_MOTOR_VIBRATE_PICO) \
    _(XrExpandDeviceCustomDataPICO, XR_TYPE_EXPAND_DEVICE_CUSTOM_DATA_PICO) \
    _(XrExpandDeviceBatteryStatePICO, XR_TYPE_EXPAND_DEVICE_BATTERY_STATE_PICO) \
    _(XrEventDataExpandDeviceConnectionStateChangedPICO, XR_TYPE_EVENT_DATA_EXPAND_DEVICE_CONNECTION_STATE_CHANGED_PICO) \
    _(XrEventDataExpandDeviceBatteryStateChangedPICO, XR_TYPE_EVENT_DATA_EXPAND_DEVICE_BATTERY_STATE_CHANGED_PICO) \
    _(XrEventDataExpandDeviceCustomDataStateChangedPICO, XR_TYPE_EVENT_DATA_EXPAND_DEVICE_CUSTOM_DATA_STATE_CHANGED_PICO) \
    _(XrBodyBoneLengthPICO, XR_TYPE_BODY_BONE_LENGTH_PICO) \
    _(XrBodyTrackingPostureFlagsDataPICO, XR_TYPE_BODY_TRACKING_POSTURE_FLAGS_DATA_PICO) \
    _(XrBodyJointVelocitiesPICO, XR_TYPE_BODY_JOINT_VELOCITIES_PICO) \
    _(XrBodyJointAccelerationsPICO, XR_TYPE_BODY_JOINT_ACCELERATIONS_PICO) \
    _(XrBodyTrackingStatePICO, XR_TYPE_BODY_TRACKING_STATE_PICO) \
    _(XrSymmetricFovReprojectionViewConfigurationPICO, XR_TYPE_SYMMETRIC_FOV_REPROJECTION_VIEW_CONFIGURATION_PICO) \
    _(XrLayerColorMatrixPICO, XR_TYPE_LAYER_COLOR_MATRIX_PICO) \
    _(XrReadbackTensorBufferPICO, XR_TYPE_READBACK_TENSOR_BUFFER_PICO) \
    _(XrCreateBufferFromGlobalTensorCompletionPICO, XR_TYPE_CREATE_BUFFER_FROM_GLOBAL_TENSOR_COMPLETION_PICO) \
    _(XrCreateTextureFromGlobalTensorCompletionPICO, XR_TYPE_CREATE_TEXTURE_FROM_GLOBAL_TENSOR_COMPLETION_PICO) \
    _(XrReadbackTextureImageBasePICO, XR_TYPE_READBACK_TEXTURE_IMAGE_BASE_PICO) \
    _(XrSystemSpatialSensingPropertiesPICO, XR_TYPE_SYSTEM_SPATIAL_SENSING_PROPERTIES_PICO) \
    _(XrSpatialEntityLocationGetInfoPICO, XR_TYPE_SPATIAL_ENTITY_LOCATION_GET_INFO_PICO) \
    _(XrSpatialEntityLocationDataPICO, XR_TYPE_SPATIAL_ENTITY_LOCATION_DATA_PICO) \
    _(XrSpatialEntitySemanticGetInfoPICO, XR_TYPE_SPATIAL_ENTITY_SEMANTIC_GET_INFO_PICO) \
    _(XrSpatialEntitySemanticDataPICO, XR_TYPE_SPATIAL_ENTITY_SEMANTIC_DATA_PICO) \
    _(XrSpatialEntityBoundingBox2DGetInfoPICO, XR_TYPE_SPATIAL_ENTITY_BOUNDING_BOX_2D_GET_INFO_PICO) \
    _(XrSpatialEntityBoundingBox2DDataPICO, XR_TYPE_SPATIAL_ENTITY_BOUNDING_BOX_2D_DATA_PICO) \
    _(XrSpatialEntityPolygonGetInfoPICO, XR_TYPE_SPATIAL_ENTITY_POLYGON_GET_INFO_PICO) \
    _(XrSpatialEntityPolygonDataPICO, XR_TYPE_SPATIAL_ENTITY_POLYGON_DATA_PICO) \
    _(XrSpatialEntityBoundingBox3DGetInfoPICO, XR_TYPE_SPATIAL_ENTITY_BOUNDING_BOX_3D_GET_INFO_PICO) \
    _(XrSpatialEntityBoundingBox3DDataPICO, XR_TYPE_SPATIAL_ENTITY_BOUNDING_BOX_3D_DATA_PICO) \
    _(XrSpatialEntityTriangleMeshGetInfoPICO, XR_TYPE_SPATIAL_ENTITY_TRIANGLE_MESH_GET_INFO_PICO) \
    _(XrSpatialEntityTriangleMeshDataPICO, XR_TYPE_SPATIAL_ENTITY_TRIANGLE_MESH_DATA_PICO) \
    _(XrSenseDataProviderStartInfoPICO, XR_TYPE_SENSE_DATA_PROVIDER_START_INFO_PICO) \
    _(XrSenseDataProviderStartCompletionPICO, XR_TYPE_SENSE_DATA_PROVIDER_START_COMPLETION_PICO) \
    _(XrEventDataSenseDataProviderStateChangedPICO, XR_TYPE_EVENT_DATA_SENSE_DATA_PROVIDER_STATE_CHANGED_PICO) \
    _(XrEventDataSenseDataUpdatedPICO, XR_TYPE_EVENT_DATA_SENSE_DATA_UPDATED_PICO) \
    _(XrSenseDataQueryInfoPICO, XR_TYPE_SENSE_DATA_QUERY_INFO_PICO) \
    _(XrSenseDataQueryCompletionPICO, XR_TYPE_SENSE_DATA_QUERY_COMPLETION_PICO) \
    _(XrQueriedSenseDataGetInfoPICO, XR_TYPE_QUERIED_SENSE_DATA_GET_INFO_PICO) \
    _(XrSpatialEntityStatePICO, XR_TYPE_SPATIAL_ENTITY_STATE_PICO) \
    _(XrQueriedSenseDataPICO, XR_TYPE_QUERIED_SENSE_DATA_PICO) \
    _(XrSenseDataFilterUuidPICO, XR_TYPE_SENSE_DATA_FILTER_UUID_PICO) \
    _(XrSenseDataFilterSemanticPICO, XR_TYPE_SENSE_DATA_FILTER_SEMANTIC_PICO) \
    _(XrSpatialEntityAnchorRetrieveInfoPICO, XR_TYPE_SPATIAL_ENTITY_ANCHOR_RETRIEVE_INFO_PICO) \
    _(XrAnchorLocateInfoPICO, XR_TYPE_ANCHOR_LOCATE_INFO_PICO) \
    _(XrFuturePollResultProgressPICO, XR_TYPE_FUTURE_POLL_RESULT_PROGRESS_PICO) \
    _(XrSystemSpatialAnchorPropertiesPICO, XR_TYPE_SYSTEM_SPATIAL_ANCHOR_PROPERTIES_PICO) \
    _(XrSenseDataProviderCreateInfoSpatialAnchorPICO, XR_TYPE_SENSE_DATA_PROVIDER_CREATE_INFO_SPATIAL_ANCHOR_PICO) \
    _(XrSpatialAnchorCreateInfoPICO, XR_TYPE_SPATIAL_ANCHOR_CREATE_INFO_PICO) \
    _(XrSpatialAnchorCreateCompletionPICO, XR_TYPE_SPATIAL_ANCHOR_CREATE_COMPLETION_PICO) \
    _(XrSpatialAnchorPersistInfoPICO, XR_TYPE_SPATIAL_ANCHOR_PERSIST_INFO_PICO) \
    _(XrSpatialAnchorPersistCompletionPICO, XR_TYPE_SPATIAL_ANCHOR_PERSIST_COMPLETION_PICO) \
    _(XrSpatialAnchorUnpersistInfoPICO, XR_TYPE_SPATIAL_ANCHOR_UNPERSIST_INFO_PICO) \
    _(XrSpatialAnchorUnpersistCompletionPICO, XR_TYPE_SPATIAL_ANCHOR_UNPERSIST_COMPLETION_PICO) \
    _(XrSystemSpatialAnchorSharingPropertiesPICO, XR_TYPE_SYSTEM_SPATIAL_ANCHOR_SHARING_PROPERTIES_PICO) \
    _(XrSpatialAnchorShareInfoPICO, XR_TYPE_SPATIAL_ANCHOR_SHARE_INFO_PICO) \
    _(XrSpatialAnchorShareCompletionPICO, XR_TYPE_SPATIAL_ANCHOR_SHARE_COMPLETION_PICO) \
    _(XrSharedSpatialAnchorDownloadInfoPICO, XR_TYPE_SPATIAL_ANCHOR_DOWNLOAD_INFO_PICO) \
    _(XrSharedSpatialAnchorDownloadCompletionPICO, XR_TYPE_SPATIAL_ANCHOR_DOWNLOAD_COMPLETION_PICO) \
    _(XrSystemSceneCapturePropertiesPICO, XR_TYPE_SYSTEM_SCENE_CAPTURE_PROPERTIES_PICO) \
    _(XrSenseDataProviderCreateInfoSceneCapturePICO, XR_TYPE_SENSE_DATA_PROVIDER_CREATE_INFO_SCENE_CAPTURE_PICO) \
    _(XrSceneCaptureStartInfoPICO, XR_TYPE_SCENE_CAPTURE_START_INFO_PICO) \
    _(XrSceneCaptureStartCompletionPICO, XR_TYPE_SCENE_CAPTURE_START_COMPLETION_PICO) \
    _(XrSystemSpatialMeshPropertiesPICO, XR_TYPE_SYSTEM_SPATIAL_MESH_PROPERTIES_PICO) \
    _(XrSenseDataProviderCreateInfoSpatialMeshPICO, XR_TYPE_SENSE_DATA_PROVIDER_CREATE_INFO_SPATIAL_MESH_PICO) \
...
#define XR_LIST_STRUCTURE_TYPES_XR_USE_GRAPHICS_API_OPENGL_ES(_) \
    ...
    _(XrReadbackTextureImageOpenGLPICO, XR_TYPE_READBACK_TEXTURE_IMAGE_OPENGL_PICO) \
...
#define XR_LIST_STRUCTURE_TYPES_XR_USE_GRAPHICS_API_VULKAN(_) \
    ...
    _(XrReadbackTextureImageVulkanPICO, XR_TYPE_READBACK_TEXTURE_IMAGE_VULKAN_PICO) \
...
#define XR_LIST_EXTENSIONS(_) \
    ...
    _(XR_PICO_external_camera, 10001) \
    _(XR_PICO_virtual_boundary, 10002) \
    _(XR_PICO_motion_tracking, 10003) \
    _(XR_PICO_composition_layer_fisheye, 10004) \
    _(XR_PICO_layer_settings, 10005) \
    _(XR_PICO_eye_tracker, 10007) \
    _(XR_PICO_secure_mixed_reality, 10008) \
    _(XR_PICO_expand_device, 10009) \
    _(XR_PICO_body_tracking2, 10010) \
    _(XR_PICO_adaptive_resolution, 10011) \
    _(XR_PICO_symmetric_fov_reprojection_view_configuration, 10017) \
    _(XR_PICO_layer_color_matrix, 10027) \
    _(XR_PICO_readback_tensor, 10028) \
    _(XR_PICO_readback_tensor_vulkan, 10029) \
    _(XR_PICO_readback_tensor_opengles, 10030) \
    _(XR_PICO_spatial_sensing, 200390) \
    _(XR_PICO_spatial_anchor, 200391) \
    _(XR_PICO_spatial_anchor_sharing, 200392) \
    _(XR_PICO_scene_capture, 200393) \
    _(XR_PICO_spatial_mesh, 200394) \
...
/// For every function defined by XR_PICO_external_camera in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_external_camera(_) \
    _(GetExternalCameraInfoPICO, PICO_external_camera) \


/// For every function defined by XR_PICO_virtual_boundary in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_virtual_boundary(_) \
    _(GetVirtualBoundaryModePICO, PICO_virtual_boundary) \
    _(GetVirtualBoundaryStatusPICO, PICO_virtual_boundary) \
    _(SetVirtualBoundaryEnablePICO, PICO_virtual_boundary) \
    _(SetVirtualBoundaryVisiblePICO, PICO_virtual_boundary) \
    _(GetVirtualBoundaryGeometryPICO, PICO_virtual_boundary) \
    _(GetVirtualBoundaryTriggerPICO, PICO_virtual_boundary) \
    _(SetVirtualBoundarySeeThroughVisiblePICO, PICO_virtual_boundary) \


/// For every function defined by XR_PICO_motion_tracking in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_motion_tracking(_) \
    _(RequestMotionTrackerDevicePICO, PICO_motion_tracking) \
    _(GetMotionTrackerBatteryStatePICO, PICO_motion_tracking) \
    _(LocateMotionTrackerPICO, PICO_motion_tracking) \


/// For every function defined by XR_PICO_eye_tracker in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_eye_tracker(_) \
    _(CreateEyeTrackerPICO, PICO_eye_tracker) \
    _(DestroyEyeTrackerPICO, PICO_eye_tracker) \
    _(GetEyeDataPICO, PICO_eye_tracker) \


/// For every function defined by XR_PICO_secure_mixed_reality in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_secure_mixed_reality(_) \
    _(CreateSecureMrFrameworkPICO, PICO_secure_mixed_reality) \
    _(DestroySecureMrFrameworkPICO, PICO_secure_mixed_reality) \
    _(CreateSecureMrPipelinePICO, PICO_secure_mixed_reality) \
    _(DestroySecureMrPipelinePICO, PICO_secure_mixed_reality) \
    _(CreateSecureMrOperatorPICO, PICO_secure_mixed_reality) \
    _(CreateSecureMrTensorPICO, PICO_secure_mixed_reality) \
    _(DestroySecureMrTensorPICO, PICO_secure_mixed_reality) \
    _(CreateSecureMrPipelineTensorPICO, PICO_secure_mixed_reality) \
    _(ResetSecureMrTensorPICO, PICO_secure_mixed_reality) \
    _(ResetSecureMrPipelineTensorPICO, PICO_secure_mixed_reality) \
    _(SetSecureMrOperatorOperandByNamePICO, PICO_secure_mixed_reality) \
    _(SetSecureMrOperatorOperandByIndexPICO, PICO_secure_mixed_reality) \
    _(ExecuteSecureMrPipelinePICO, PICO_secure_mixed_reality) \
    _(SetSecureMrOperatorResultByNamePICO, PICO_secure_mixed_reality) \
    _(SetSecureMrOperatorResultByIndexPICO, PICO_secure_mixed_reality) \


/// For every function defined by XR_PICO_expand_device in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_expand_device(_) \
    _(EnumerateExpandDevicePICO, PICO_expand_device) \
    _(SetExpandDeviceMotorVibratePICO, PICO_expand_device) \
    _(GetExpandDeviceBatteryStatePICO, PICO_expand_device) \
    _(SetExpandDeviceCustomDataCapabilityPICO, PICO_expand_device) \
    _(SetExpandDeviceCustomDataPICO, PICO_expand_device) \
    _(GetExpandDeviceCustomDataPICO, PICO_expand_device) \


/// For every function defined by XR_PICO_body_tracking2 in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_body_tracking2(_) \
    _(StartBodyTrackingCalibrationAppPICO, PICO_body_tracking2) \
    _(GetBodyTrackingStatePICO, PICO_body_tracking2) \


/// For every function defined by XR_PICO_adaptive_resolution in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_adaptive_resolution(_) \
    _(UpdateAdaptiveResolutionPICO, PICO_adaptive_resolution) \


/// For every function defined by XR_PICO_readback_tensor in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_readback_tensor(_) \
    _(CreateBufferFromGlobalTensorAsyncPICO, PICO_readback_tensor) \
    _(CreateBufferFromGlobalTensorCompletePICO, PICO_readback_tensor) \
    _(CreateTextureFromGlobalTensorAsyncPICO, PICO_readback_tensor) \
    _(CreateTextureFromGlobalTensorCompletePICO, PICO_readback_tensor) \
    _(GetReadbackTextureImagePICO, PICO_readback_tensor) \
    _(ReleaseReadbackTexturePICO, PICO_readback_tensor) \


/// For every function defined by XR_PICO_spatial_sensing in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_spatial_sensing(_) \
    _(EnumerateSpatialEntityComponentTypesPICO, PICO_spatial_sensing) \
    _(GetSpatialEntityUuidPICO, PICO_spatial_sensing) \
    _(GetSpatialEntityComponentDataPICO, PICO_spatial_sensing) \
    _(CreateSenseDataProviderPICO, PICO_spatial_sensing) \
    _(StartSenseDataProviderAsyncPICO, PICO_spatial_sensing) \
    _(StartSenseDataProviderCompletePICO, PICO_spatial_sensing) \
    _(GetSenseDataProviderStatePICO, PICO_spatial_sensing) \
    _(QuerySenseDataAsyncPICO, PICO_spatial_sensing) \
    _(QuerySenseDataCompletePICO, PICO_spatial_sensing) \
    _(DestroySenseDataSnapshotPICO, PICO_spatial_sensing) \
    _(GetQueriedSenseDataPICO, PICO_spatial_sensing) \
    _(StopSenseDataProviderPICO, PICO_spatial_sensing) \
    _(DestroySenseDataProviderPICO, PICO_spatial_sensing) \
    _(RetrieveSpatialEntityAnchorPICO, PICO_spatial_sensing) \
    _(DestroyAnchorPICO, PICO_spatial_sensing) \
    _(GetAnchorUuidPICO, PICO_spatial_sensing) \
    _(LocateAnchorPICO, PICO_spatial_sensing) \


/// For every function defined by XR_PICO_spatial_anchor in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_spatial_anchor(_) \
    _(CreateSpatialAnchorAsyncPICO, PICO_spatial_anchor) \
    _(CreateSpatialAnchorCompletePICO, PICO_spatial_anchor) \
    _(PersistSpatialAnchorAsyncPICO, PICO_spatial_anchor) \
    _(PersistSpatialAnchorCompletePICO, PICO_spatial_anchor) \
    _(UnpersistSpatialAnchorAsyncPICO, PICO_spatial_anchor) \
    _(UnpersistSpatialAnchorCompletePICO, PICO_spatial_anchor) \


/// For every function defined by XR_PICO_spatial_anchor_sharing in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_spatial_anchor_sharing(_) \
    _(ShareSpatialAnchorAsyncPICO, PICO_spatial_anchor_sharing) \
    _(ShareSpatialAnchorCompletePICO, PICO_spatial_anchor_sharing) \
    _(DownloadSharedSpatialAnchorAsyncPICO, PICO_spatial_anchor_sharing) \
    _(DownloadSharedSpatialAnchorCompletePICO, PICO_spatial_anchor_sharing) \


/// For every function defined by XR_PICO_scene_capture in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_scene_capture(_) \
    _(StartSceneCaptureAsyncPICO, PICO_scene_capture) \
    _(StartSceneCaptureCompletePICO, PICO_scene_capture) \
